...
// has some bugs regarding this edge case, and letting ezburn proceed further
// leads to confusing errors that make it seem like ezburn itself has a bug.
if (!(encodeUTF8('') instanceof Uint8Array))
  throw new Error(`Invariant violation: "${encodeInvariant} instanceof Uint8Array" is incorrectly false

This indicates that your JavaScript environment is broken. You cannot use
ezburn in this environment because ezburn relies on this invariant. This
is not a problem with ezburn. You need to fix your environment instead.
`)
