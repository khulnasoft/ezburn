...
// This is ezburn's runtime code. It contains helper functions that are
...
func Source(unsupportedJSFeatures compat.JSFeature) logger.Source {
	...
	//
	// * The "tslib" library will overwrite ezburn's helper functions if the bundled
	//   code is run in the global scope: https://github.com/khulnasoft/ezburn/issues/1102
	//
	// * Running the TypeScript compiler on ezburn's output to convert ES6 to ES5
	//   will also overwrite ezburn's helper functions because TypeScript doesn't
	...
	text += `
		...
		// naturally be "function" even in non-CommonJS environments since ezburn
...
//
// Here are some examples of how ezburn's decorator transform works:
//
// ============================= Class decorator ==============================
//
