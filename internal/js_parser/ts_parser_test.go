...
func TestTSArrow(t *testing.T) {
	...
	// https://github.com/khulnasoft/ezburn/issues/4027
...
func TestTSInstantiationExpression(t *testing.T) {
	...
	// See: https://github.com/khulnasoft/ezburn/issues/2201
...
func TestTSTypeOnlyExport(t *testing.T) {
	...
	// people blame ezburn when it doesn't parse. It's silently discarded
...
func TestTSES5(t *testing.T) {
	...
	// function return type. See: https://github.com/khulnasoft/ezburn/issues/2375.
