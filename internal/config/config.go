...
func (tsConfig *TSConfigJSX) ApplyTo(jsxOptions *JSXOptions) {
	...
	case TSJSXPreserve, TSJSXReactNative:
		...
		// people are then confused when ezburn preserves their JSX. Ignoring this
		// value means you now have to explicitly pass "--jsx=preserve" to ezburn
	...
	case TSJSXReactJSX:
		...
		// that to "react-jsxdev" by passing "--jsx-dev" to ezburn.
...
type InjectedFile struct {
	...
	Source       logger.Source
	IsCopyLoader bool // If you set the loader to "copy" (see https://github.com/khulnasoft/ezburn/issues/3041)
}
