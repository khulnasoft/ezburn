...
// See: https://github.com/khulnasoft/ezburn/issues/2147
...
NOTE: Node's package format requires that CommonJS files in a "type": "module" package use the ".cjs" file extension. If you are using TypeScript, you can use the ".cts" file extension with ezburn instead.
`,
	})
}
