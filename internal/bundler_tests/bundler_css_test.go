...
// See: https://github.com/khulnasoft/ezburn/issues/3295
...
func TestCSSAtImportConditionsWithImportRecordsBundle(t *testing.T) {
	// This tests that ezburn correctly clones the import records for all import
...
// serve to document any changes in ezburn's behavior. Any changes in behavior
// should be tested to ensure they don't cause any regressions. The easiest way
// to test the changes is to bundle https://github.com/khulnasoft/css-import-tests
...
func TestCSSNestingOldBrowser(t *testing.T) {
	css_suite.expectBundled(t, bundled{
		files: map[string]string{
			...
			// See: https://github.com/khulnasoft/ezburn/issues/3197
