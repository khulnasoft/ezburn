const { installForTests, removeRecursiveSync, writeFileAtomic } = require('./ezburn')
...
let buildTests = {
  async errorIfEntryPointsNotArray({ ezburn }) {
    try {
      await ezburn.build({
  ...
  async errorIfBadWorkingDirectory({ ezburn }) {
    try {
      await ezburn.build({
  ...
  async errorIfExtensionlessLoaderIsDisabled({ ezburn, testDir }) {
  ...
  async mangleCacheBuild({ ezburn }) {
    var result = await ezburn.build({
      stdin: {
  ...
  async windowsBackslashPathTest({ ezburn, testDir }) {
    let entry = path.join(testDir, 'entry.js');
  ...
  async workingDirTest({ ezburn, testDir }) {
  ...
  async pathResolverEACCS({ ezburn, testDir }) {
  ...
  async nodePathsTest({ ezburn, testDir }) {
  ...
  // See: https://github.com/khulnasoft/ezburn/issues/1117
  async nodePathsLocalPreferredTestIssue1117({ ezburn, testDir }) {
    let srcDir = path.join(testDir, 'src');
  ...
  async es6_to_cjs({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, 'export default 123')
    const value = await ezburn.build({
      entryPoints: [input],
      bundle: true,
      outfile: output,
      format: 'cjs',
  ...
  async recursiveMkdir({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async outExtensionJS({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async outExtensionCSS({ ezburn, testDir }) {
  ...
  async sourceMapTrue({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
  ...
  async sourceMapLinked({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const content = 'exports.foo = 123'
    await writeFileAsync(input, content)
  ...
  async sourceMapExternal({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const content = 'exports.foo = 123'
    await writeFileAsync(input, content)
  ...
  async sourceMapInline({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const content = 'exports.foo = 123'
    await writeFileAsync(input, content)
  ...
  async sourceMapBoth({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const content = 'exports.foo = 123'
    await writeFileAsync(input, content)
  ...
  async sourceMapIncludeSourcesContent({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const content = 'exports.foo = 123'
    await writeFileAsync(input, content)
  ...
  async sourceMapExcludeSourcesContent({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const content = 'exports.foo = 123'
    await writeFileAsync(input, content)
  ...
  async sourceMapSourceRoot({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const content = 'exports.foo = 123'
    await writeFileAsync(input, content)
  ...
  async sourceMapWithDisabledFile({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async sourceMapWithEmptyFile({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async sourceMapWithDisabledModule({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async resolveExtensionOrder({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js');
  ...
  async defineObject({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js');
    const output = path.join(testDir, 'out.js')
  ...
  async minifyWithoutInject({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js');
    const output = path.join(testDir, 'out.js')
  ...
  async minifyWithInject({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js');
    const inject = path.join(testDir, 'inject.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, 'function exampleFn() { return Math.min(4, 3) }')
  ...
  async mainFields({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
  ...
  async requireAbsolutePath({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async buildLoaderStdinBase64({ ezburn }) {
    // UTF-16
    var result = await ezburn.build({
      stdin: {
        contents: `\xFF`,
  ...
  async fileLoader({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async fileLoaderEntryHash({ ezburn, testDir }) {
    const input = path.join(testDir, 'index.js')
    const data = path.join(testDir, 'data.bin')
    const outdir = path.join(testDir, 'out')
    await writeFileAsync(input, `export {default as value} from ${JSON.stringify(data)}`)
    await writeFileAsync(data, `stuff`)
    const result1 = await ezburn.build({
      entryPoints: [input],
      bundle: true,
      outdir,
      format: 'cjs',
    ...
    const result2 = await ezburn.build({
      entryPoints: [input],
      bundle: true,
      outdir,
      format: 'cjs',
  ...
  async fileLoaderEntryHashNoChange({ ezburn, testDir }) {
    const input = path.join(testDir, 'index.js')
    const data = path.join(testDir, 'data.bin')
    const outdir = path.join(testDir, 'out')
    await writeFileAsync(input, `export {default as value} from ${JSON.stringify(data)}`)
  ...
  async splittingPublicPath({ ezburn, testDir }) {
...
`)
  ...
  async publicPathHashing({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const data = path.join(testDir, 'data.bin')
    const outdir = path.join(testDir, 'out')
  ...
  async fileLoaderPublicPath({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const data = path.join(testDir, 'data.bin')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `export {default as value} from ${JSON.stringify(data)}`)
  ...
  async fileLoaderCSS({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.css')
    const data = path.join(testDir, 'data.bin')
...
`)
  ...
  async fileLoaderWithAssetPath({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const data = path.join(testDir, 'data.bin')
    const outdir = path.join(testDir, 'out')
    await writeFileAsync(input, `export {default as value} from ${JSON.stringify(data)}`)
  ...
  async fileLoaderWithAssetPathAndPublicPath({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const data = path.join(testDir, 'data.bin')
    const outdir = path.join(testDir, 'out')
    await writeFileAsync(input, `export {default as value} from ${JSON.stringify(data)}`)
  ...
  async fileLoaderBinaryVsText({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async metafileSplitting({ ezburn, testDir }) {
  ...
  async metafileSplittingPublicPath({ ezburn, testDir }) {
    const entry1 = path.join(testDir, 'entry1.js')
    const entry2 = path.join(testDir, 'entry2.js')
    const imported = path.join(testDir, 'imported.js')
    const outdir = path.join(testDir, 'out')
  ...
  async metafileSplittingDoubleDynamicImport({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
  ...
  async metafileCJSInFormatIIFE({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
  ...
  async metafileCJSInFormatCJS({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
    const outfile = path.join(testDir, 'out.js')
    await writeFileAsync(entry, `module.exports = {}`)
    const result = await ezburn.build({
  ...
  async metafileCJSInFormatESM({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
    const outfile = path.join(testDir, 'out.js')
    await writeFileAsync(entry, `module.exports = {}`)
    const result = await ezburn.build({
  ...
  async metafileESMInFormatIIFE({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
    const outfile = path.join(testDir, 'out.js')
  ...
  async metafileESMInFormatCJS({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
    const outfile = path.join(testDir, 'out.js')
    await writeFileAsync(entry, `export let a = 1, b = 2`)
    const result = await ezburn.build({
  ...
  async metafileESMInFormatESM({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
    const outfile = path.join(testDir, 'out.js')
    await writeFileAsync(entry, `export let a = 1, b = 2`)
    const result = await ezburn.build({
  ...
  async metafileNestedExportNames({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
  ...
  async metafileCSS({ ezburn, testDir }) {
  ...
  async metafileLoaderFileMultipleEntry({ ezburn, testDir }) {
    const entry1 = path.join(testDir, 'entry1.js')
    const entry2 = path.join(testDir, 'entry2.js')
  ...
  async writeFalse({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
  ...
  async allowOverwrite({ ezburn, testDir }) {
  ...
  async splittingRelativeSameDir({ ezburn, testDir }) {
...
`)
  ...
  async splittingRelativeNestedDir({ ezburn, testDir }) {
...
`)
  ...
  async splittingWithChunkPath({ ezburn, testDir }) {
    const inputA = path.join(testDir, 'a/demo.js')
    const inputB = path.join(testDir, 'b/demo.js')
    const inputCommon = path.join(testDir, 'common.js')
    await mkdirAsync(path.dirname(inputA)).catch(x => x)
...
`)
  ...
  async splittingWithEntryHashes({ ezburn, testDir }) {
    const inputA = path.join(testDir, 'a/demo.js')
    const inputB = path.join(testDir, 'b/demo.js')
    const inputCommon = path.join(testDir, 'common.js')
    await mkdirAsync(path.dirname(inputA)).catch(x => x)
...
`)
  ...
  async splittingWithChunkPathAndCrossChunkImportsIssue899({ ezburn, testDir }) {
  ...
  async splittingStaticImportHashChange({ ezburn, testDir }) {
    const input1 = path.join(testDir, 'a', 'in1.js')
    const input2 = path.join(testDir, 'b', 'in2.js')
    const outdir = path.join(testDir, 'out')
  ...
  async splittingDynamicImportHashChangeIssue1076({ ezburn, testDir }) {
    const input1 = path.join(testDir, 'a', 'in1.js')
    const input2 = path.join(testDir, 'b', 'in2.js')
    const outdir = path.join(testDir, 'out')
  ...
  async stdinStdoutBundle({ ezburn, testDir }) {
...
`)
  ...
  async stdinOutfileBundle({ ezburn, testDir }) {
    const auxiliary = path.join(testDir, 'auxiliary.js')
    const outfile = path.join(testDir, 'out.js')
    await writeFileAsync(auxiliary, 'export default 123')
    const value = await ezburn.build({
  ...
  async stdinAndEntryBundle({ ezburn, testDir }) {
  ...
  async forceTsConfig({ ezburn, testDir }) {
    // ./tsconfig.json
...
`)
  ...
  async forceTsConfigRaw({ ezburn, testDir }) {
    // ./a/tsconfig.json
    // ./a/b/test-impl.js
    // ./a/b/c/in.js
    const aDir = path.join(testDir, 'a')
...
`)
  ...
  async forceTsConfigRawStdin({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
...
`)
  ...
  async outbaseImplicit({ ezburn, testDir }) {
  ...
  async outbaseRelPath({ ezburn, testDir }) {
  ...
  async outbaseAbsPath({ ezburn, testDir }) {
    const outbase = path.join(testDir, 'pages')
    const b = path.join(outbase, 'a', 'b', 'index.js')
    const c = path.join(outbase, 'a', 'c', 'index.js')
    const outdir = path.join(testDir, 'outdir')
  ...
  async bundleTreeShakingDefault({ ezburn }) {
    const { outputFiles } = await ezburn.build({
      stdin: {
        contents: `
  ...
  async bundleTreeShakingTrue({ ezburn }) {
    const { outputFiles } = await ezburn.build({
      stdin: {
        contents: `
          let removeMe1 = /* @__PURE__ */ fn();
  ...
  async bundleTreeShakingIgnoreAnnotations({ ezburn }) {
    const { outputFiles } = await ezburn.build({
      stdin: {
        contents: `
...
`)
  ...
  async externalWithWildcard({ ezburn }) {
    const { outputFiles } = await ezburn.build({
      stdin: {
...
`)
  ...
  async externalPackages({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
...
`)
  ...
  async errorInvalidExternalWithTwoWildcards({ ezburn }) {
    try {
      await ezburn.build({
        entryPoints: ['in.js'],
        external: ['a*b*c'],
  ...
  async jsBannerBuild({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const outfile = path.join(testDir, 'out.js')
  ...
  async jsFooterBuild({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const outfile = path.join(testDir, 'out.js')
  ...
  async jsBannerFooterBuild({ ezburn, testDir }) {
  ...
  async cssBannerFooterBuild({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.css')
  ...
  async buildRelativeIssue693({ ezburn }) {
    const result = await ezburn.build({
      stdin: {
        contents: `const x=1`,
      },
    ...
    assert.strictEqual(result.outputFiles[0].path, path.join(process.cwd(), 'ezburn.js'))
    assert.strictEqual(result.outputFiles[0].text, 'const x = 1;\n')
  },

  async rebuildBasic({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
  ...
  async rebuildMerging({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `console.log(123)`)
  ...
  async rebuildIndependent({ ezburn, testDir }) {
    ...
    const contextA = await ezburn.context({
      entryPoints: [inputA],
      outfile: outputA,
      format: 'esm',
    })
    const contextB = await ezburn.context({
      entryPoints: [inputB],
      outfile: outputB,
      format: 'esm',
    })
  ...
  async rebuildParallel({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const context = await ezburn.context({
      entryPoints: [input],
  ...
  // threading.
  async rapidRebuildCancel({ ezburn }) {
    const context = await ezburn.context({
      entryPoints: ['entry'],
      logLevel: 'silent',
      plugins: [{
  ...
  async bundleAvoidTDZ({ ezburn }) {
    var { outputFiles } = await ezburn.build({
      stdin: {
        contents: `
          class Foo {
  ...
  async bundleTSDecoratorAvoidTDZ({ testDir, ezburn }) {
  ...
  async automaticEntryPointOutputPathsWithDot({ ezburn, testDir }) {
  ...
  async customEntryPointOutputPathsWithDot({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.file.ts')
    const css = path.join(testDir, 'file.css')
    await writeFileAsync(input, `import './file.css'; console.log('test')`)
    await writeFileAsync(css, `body { color: red }`)
  ...
  async customEntryPointOutputPathsRel({ ezburn, testDir }) {
  ...
  async customEntryPointOutputPathsAbs({ ezburn, testDir }) {
    const input1 = path.join(testDir, 'in1.js')
    const input2 = path.join(testDir, 'in2.js')
  ...
  async customEntryPointOutputPathsDuplicates({ ezburn, testDir }) {
  ...
  async nodeColonPrefixImport({ ezburn }) {
  ...
  async nodeColonPrefixRequire({ ezburn }) {
    const tryTargetESM = async target => {
      const result = await ezburn.build({
  ...
  async nodeColonPrefixImportTurnedIntoRequire({ ezburn }) {
    const tryTargetESM = async target => {
      const result = await ezburn.build({
        stdin: { contents: `import fs from 'node:fs'; import('node:fs'); fs()` },
        bundle: true,
...
`)
  ...
  async yarnPnP_pnp_data_json({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
...
`)
  ...
  async yarnPnP_pnp_js_object_literal({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
...
`)
  ...
  async yarnPnP_pnp_cjs_JSON_parse_string_literal({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
...
`)
  ...
  async yarnPnP_pnp_cjs_JSON_parse_identifier({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
    const manifest = path.join(testDir, '.pnp.cjs')
    const leftPad = path.join(testDir, '.yarn', 'cache', 'left-pad-zip', 'node_modules', 'left-pad', 'index.js')
...
`)
  ...
  async yarnPnP_ignoreNestedManifests({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
...
`)
  ...
  async yarnPnP_tsconfig({ ezburn, testDir }) {
...
`)
  ...
  async yarnPnP_indexJs({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
...
`)
  ...
  async yarnPnP_depOfVirtual({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
...
`)
  ...
  // https://github.com/khulnasoft/ezburn/issues/3915
  async yarnPnP_stackOverflow({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.jsx')
...
let watchTests = {
  ...
  async watchEditSession({ ezburn, testDir }) {
    const srcDir = path.join(testDir, 'src')
    const outfile = path.join(testDir, 'out.js')
  ...
  async watchWriteFalse({ ezburn, testDir }) {
    const srcDir = path.join(testDir, 'src')
    const outdir = path.join(testDir, 'out')
    const input = path.join(srcDir, 'in.js')
  ...
  async watchMetafile({ ezburn, testDir }) {
    const srcDir = path.join(testDir, 'src')
    const outdir = path.join(testDir, 'out')
    const input = path.join(srcDir, 'in.js')
    const output = path.join(outdir, 'in.js')
  ...
  async watchMangleCache({ ezburn, testDir }) {
    const srcDir = path.join(testDir, 'src')
    const outdir = path.join(testDir, 'out')
    const input = path.join(srcDir, 'in.js')
    const output = path.join(outdir, 'in.js')
  ...
  // See: https://github.com/khulnasoft/ezburn/issues/3062
  async watchNodePaths({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const outfile = path.join(testDir, 'out.js')
...
let serveTests = {
  ...
  async serveWatch({ ezburn, testDir }) {
  ...
  async serveBasic({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    await writeFileAsync(input, `console.log(123)`)
  ...
  async serveBasicHTTPS({ ezburn, testDir }) {
  ...
  async serveSlashRedirect({ ezburn, testDir }) {
  ...
  async serveOutfile({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const outfile = path.join(testDir, 'out.js')
    await writeFileAsync(input, `console.log(123)`)
  ...
  async serveWithServedir({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async serveWithServedirAndSiblingOutputDir({ ezburn, testDir }) {
    const context = await ezburn.context({
  ...
  async serveWithServedirAndParentOutputDir({ ezburn, testDir }) {
    const context = await ezburn.context({
      entryPoints: [path.join(testDir, 'in.js')],
      outdir: testDir,
      absWorkingDir: testDir,
  ...
  async serveWithServedirAndOutputDir({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async serveWithServedirNoEntryPoints({ ezburn, testDir }) {
  ...
  async serveRange({ ezburn, testDir }) {
  ...
  async serveWatchCopyLoaderWithEntryPoint({ ezburn, testDir }) {
  ...
  async serveWithoutServedirWatchLiveReload({ ezburn, testDir }) {
    ...
    try {
      ...
      const stream = await makeEventStream(server.hosts[0], server.port, '/ezburn')
  ...
  async serveWithServedirWatchLiveReload({ ezburn, testDir }) {
    const js = path.join(testDir, 'app.js')
    const css = path.join(testDir, 'app.css')
    const outdir = path.join(testDir, 'out')
    await writeFileAsync(css, ``)
  ...
  async serveWithoutServedirWatchLiveReloadPublicPath({ ezburn, testDir }) {
    const js = path.join(testDir, 'app.js')
    const css = path.join(testDir, 'app.css')
    const outdir = path.join(testDir, 'out')
    await writeFileAsync(css, ``)
  ...
  async serveWithServedirWatchLiveReloadPublicPath({ ezburn, testDir }) {
    const js = path.join(testDir, 'app.js')
    const css = path.join(testDir, 'app.css')
    const outdir = path.join(testDir, 'out')
    await writeFileAsync(css, ``)
  ...
  async serveWithFallback({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const wwwDir = path.join(testDir, 'www')
  ...
  async serveHostCheckIPv4({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    await writeFileAsync(input, `console.log(123)`)
  ...
  async serveHostCheckIPv6({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    await writeFileAsync(input, `console.log(123)`)
...
async function futureSyntax(ezburn, js, targetBelow, targetAbove) {
  failure: {
    try { await ezburn.transform(js, { target: targetBelow }) }
    catch { break failure }
    throw new Error(`Expected failure for ${targetBelow}: ${js}`)
  }

  try { await ezburn.transform(js, { target: targetAbove }) }
  catch (e) { throw new Error(`Expected success for ${targetAbove}: ${js}\n${e}`) }
}

let transformTests = {
  async transformWithNonString({ ezburn }) {
    try {
      await ezburn.transform(Object.create({ toString() { return '1+2' } }))
      throw new Error('Expected an error to be thrown');
    } catch (e) {
  ...
  async version({ ezburn }) {
    const version = fs.readFileSync(path.join(repoDir, 'version.txt'), 'utf8').trim()
    assert.strictEqual(ezburn.version, version);
  },

  async ignoreUndefinedOptions({ ezburn }) {
    // This should not throw
    await ezburn.transform(``, { jsxFactory: void 0 })
  },

  async throwOnBadOptions({ ezburn }) {
    // This should throw
    try {
      await ezburn.transform(``, { jsxFactory: ['React', 'createElement'] })
  ...
  async transformLoaderBase64({ ezburn }) {
    // UTF-16
    var result = await ezburn.transform(`\xFF`, { loader: 'base64' })
    assert.strictEqual(result.code, `module.exports = "w78=";\n`)

    // Binary
    var result = await ezburn.transform(new Uint8Array([0xFF]), { loader: 'base64' })
    assert.strictEqual(result.code, `module.exports = "/w==";\n`)
  },

  async avoidTDZ({ ezburn }) {
    var { code } = await ezburn.transform(`
      class Foo {
        // The above line will be transformed into "var". However, the
        // symbol "Foo" must still be defined before the class body ends.
        static foo = new Foo
  ...
  async tsDecoratorAvoidTDZ({ ezburn }) {
    var { code } = await ezburn.transform(`
      class Bar {}
      var oldFoo
      function swap(target) {
  ...
  async mangleQuotedTransform({ ezburn }) {
    var { code } = await ezburn.transform(`x.foo_ = 'foo_' in x`, {
      mangleProps: /_/,
      mangleQuoted: true,
    })
  ...
  async mangleCacheTransform({ ezburn }) {
    var { code, mangleCache } = await ezburn.transform(`x = { x_: 0, y_: 1, z_: 2 }`, {
      mangleProps: /_/,
      mangleCache: { x_: 'FIXED', z_: false },
    })
  ...
  async jsBannerTransform({ ezburn }) {
    var { code } = await ezburn.transform(`
  ...
  async jsFooterTransform({ ezburn }) {
    var { code } = await ezburn.transform(`
      footer()
    `, {
  ...
  async jsBannerFooterTransform({ ezburn }) {
    var { code } = await ezburn.transform(`
  ...
  async cssBannerFooterTransform({ ezburn }) {
  ...
  async transformDirectEval({ ezburn }) {
    var { code } = await ezburn.transform(`
      export let abc = 123
  ...
  async tsconfigRawImportsNotUsedAsValuesDefault({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {},
      },
      loader: 'ts',
  ...
  async tsconfigRawImportsNotUsedAsValuesRemove({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {
  ...
  async tsconfigRawImportsNotUsedAsValuesPreserve({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {
  ...
  async tsconfigRawImportsNotUsedAsValuesError({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {
  ...
  async tsconfigRawImportsNotUsedAsValuesRemoveJS({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {
          importsNotUsedAsValues: 'remove',
  ...
  async tsconfigRawImportsNotUsedAsValuesPreserveJS({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {
          importsNotUsedAsValues: 'preserve',
  ...
  async tsconfigRawPreserveValueImportsDefault({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {},
      },
  ...
  async tsconfigRawPreserveValueImportsFalse({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {
  ...
  async tsconfigRawPreserveValueImportsTrue({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {
  ...
  async tsconfigRawPreserveValueImportsTrueMinifyIdentifiers({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {
          preserveValueImports: true,
  ...
  async tsconfigRawPreserveValueImportsTrueImportsNotUsedAsValuesRemove({ ezburn }) {
    const { code } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: {
        compilerOptions: {
          importsNotUsedAsValues: 'remove',
  ...
  async tsconfigRawCommentsInJSON({ ezburn }) {
    // Can use a string, which allows weird TypeScript pseudo-JSON with comments and trailing commas
    const { code: code5 } = await ezburn.transform(`import {T} from 'path'`, {
      tsconfigRaw: `{
        "compilerOptions": {
  ...
  async tsconfigRawUseDefineForClassFields({ ezburn }) {
    const { code: code1 } = await ezburn.transform(`class Foo { foo }`, {
      tsconfigRaw: {
        compilerOptions: {
          useDefineForClassFields: false,
        },
    ...
    const { code: code2 } = await ezburn.transform(`class Foo { foo }`, {
      tsconfigRaw: {
        compilerOptions: {
  ...
  async tsconfigRawAlwaysStrict({ ezburn }) {
    const input = `console.log(123)`

    assert.strictEqual((await ezburn.transform(input, { loader: 'ts', tsconfigRaw: { compilerOptions: { strict: false } } })).code, `console.log(123);\n`)
    assert.strictEqual((await ezburn.transform(input, { loader: 'ts', tsconfigRaw: { compilerOptions: { alwaysStrict: false } } })).code, `console.log(123);\n`)
    assert.strictEqual((await ezburn.transform(input, { loader: 'ts', tsconfigRaw: { compilerOptions: { alwaysStrict: false, strict: true } } })).code, `console.log(123);\n`)

    assert.strictEqual((await ezburn.transform(input, { loader: 'ts', tsconfigRaw: { compilerOptions: { strict: true } } })).code, `"use strict";\nconsole.log(123);\n`)
    assert.strictEqual((await ezburn.transform(input, { loader: 'ts', tsconfigRaw: { compilerOptions: { alwaysStrict: true } } })).code, `"use strict";\nconsole.log(123);\n`)
    assert.strictEqual((await ezburn.transform(input, { loader: 'ts', tsconfigRaw: { compilerOptions: { alwaysStrict: true, strict: false } } })).code, `"use strict";\nconsole.log(123);\n`)
  },

  async tsconfigRawTarget({ ezburn }) {
    // The "target" from "tsconfig.json" should not apply, but ezburn's "target" should apply

    assert.strictEqual((await ezburn.transform('x => x', { loader: 'ts', tsconfigRaw: { compilerOptions: { target: 'ES6' } } })).code, `(x) => x;\n`)
    assert.strictEqual((await ezburn.transform('x => x', { loader: 'ts', tsconfigRaw: { compilerOptions: { target: 'ES5' } } })).code, `(x) => x;\n`)

    assert.strictEqual((await ezburn.transform('x => x', { loader: 'ts', target: 'es6' })).code, `(x) => x;\n`)
    assert.strictEqual((await ezburn.transform('x => x', { loader: 'ts', target: 'es5' })).code, `(function(x) {\n  return x;\n});\n`)

    assert.strictEqual((await ezburn.transform('x => x', { loader: 'ts', target: 'es5', tsconfigRaw: { compilerOptions: { target: 'ES6' } } })).code, `(function(x) {\n  return x;\n});\n`)
    assert.strictEqual((await ezburn.transform('x => x', { loader: 'ts', target: 'es6', tsconfigRaw: { compilerOptions: { target: 'ES5' } } })).code, `(x) => x;\n`)
  },

  async tsconfigRawExtends({ ezburn }) {
    // Uses of "extends" in "tsconfigRaw" should be ignored for the transform API
    const result = await ezburn.transform('let foo: bar', {
      loader: 'ts',
  ...
  async tsImplicitUseDefineForClassFields({ ezburn }) {
    var { code } = await ezburn.transform(`class Foo { foo }`, {
      loader: 'ts',
    })
...
`)
  ...
  async tsconfigRawJSX({ ezburn }) {
    const { code: code1 } = await ezburn.transform(`<><div/></>`, {
      tsconfigRaw: {
        compilerOptions: {
        },
      },
    ...
    const { code: code2 } = await ezburn.transform(`<><div/></>`, {
      tsconfigRaw: {
        compilerOptions: {
          jsxFactory: 'factory',
    ...
    const { code: code3 } = await ezburn.transform(`<><div/></>`, {
      tsconfigRaw: {
        compilerOptions: {
          jsx: 'react-jsx'
        },
    ...
    const { code: code4 } = await ezburn.transform(`<><div/></>`, {
      tsconfigRaw: {
        compilerOptions: {
          jsx: 'react-jsx',
    ...
    const { code: code5 } = await ezburn.transform(`<><div/></>`, {
      tsconfigRaw: {
        compilerOptions: {
          jsx: 'react-jsxdev'
        },
  ...
  async treeShakingDefault({ ezburn }) {
    const { code } = await ezburn.transform(`
      var unused = 123
      var used = 234
      export { used }
    `, {
  ...
  async treeShakingDefaultIIFE({ ezburn }) {
    const { code } = await ezburn.transform(`var unused = 123`, {
      loader: 'jsx',
      format: 'iife',
      treeShaking: undefined,
    })
  ...
  async treeShakingFalseIIFE({ ezburn }) {
    const { code } = await ezburn.transform(`var unused = 123`, {
      loader: 'jsx',
      format: 'iife',
      treeShaking: false,
  ...
  async treeShakingTrueIIFE({ ezburn }) {
    const { code } = await ezburn.transform(`var unused = 123`, {
      loader: 'jsx',
      format: 'iife',
      treeShaking: true,
  ...
  async ignoreAnnotationsDefault({ ezburn }) {
    const { code } = await ezburn.transform(`/* @__PURE__ */ fn(); <div/>`, {
      loader: 'jsx',
      minifySyntax: true,
    })
    assert.strictEqual(code, ``)
  ...
  async ignoreAnnotationsFalse({ ezburn }) {
    const { code } = await ezburn.transform(`/* @__PURE__ */ fn(); <div/>`, {
      loader: 'jsx',
      minifySyntax: true,
  ...
  async ignoreAnnotationsTrue({ ezburn }) {
    const { code } = await ezburn.transform(`/* @__PURE__ */ fn(); <div/>`, {
      loader: 'jsx',
      minifySyntax: true,
      ignoreAnnotations: true,
  ...
  async jsCharsetDefault({ ezburn }) {
    const { code } = await ezburn.transform(`let π = 'π'`, {})
    assert.strictEqual(code, `let \\u03C0 = "\\u03C0";\n`)
  },

  async jsCharsetASCII({ ezburn }) {
    const { code } = await ezburn.transform(`let π = 'π'`, { charset: 'ascii' })
    assert.strictEqual(code, `let \\u03C0 = "\\u03C0";\n`)
  },

  async jsCharsetUTF8({ ezburn }) {
    const { code } = await ezburn.transform(`let π = 'π'`, { charset: 'utf8' })
    assert.strictEqual(code, `let π = "π";\n`)
  },

  async cssCharsetDefault({ ezburn }) {
    const { code } = await ezburn.transform(`.π:after { content: 'π' }`, { loader: 'css' })
    assert.strictEqual(code, `.\\3c0:after {\n  content: "\\3c0";\n}\n`)
  },

  async cssCharsetASCII({ ezburn }) {
    const { code } = await ezburn.transform(`.π:after { content: 'π' }`, { loader: 'css', charset: 'ascii' })
    assert.strictEqual(code, `.\\3c0:after {\n  content: "\\3c0";\n}\n`)
  },

  async cssCharsetUTF8({ ezburn }) {
    const { code } = await ezburn.transform(`.π:after { content: 'π' }`, { loader: 'css', charset: 'utf8' })
    assert.strictEqual(code, `.π:after {\n  content: "π";\n}\n`)
  },

  async cssSyntaxErrorWarning({ ezburn }) {
    const { code } = await ezburn.transform(`. {}`, { loader: 'css' })
    assert.strictEqual(code, `. {\n}\n`)
  },

  async cssSyntaxErrorWarningOverride({ ezburn }) {
    try {
      await ezburn.transform(`. {}`, { loader: 'css', logOverride: { 'css-syntax-error': 'error' } })
  ...
  async cssMinify({ ezburn }) {
    const { code } = await ezburn.transform(`div { color: #abcd }`, { loader: 'css', minify: true })
    assert.strictEqual(code, `div{color:#abcd}\n`)
  },

  // Using an "es" target shouldn't affect CSS
  async cssMinifyTargetES6({ ezburn }) {
    const { code } = await ezburn.transform(`div { color: #abcd }`, { loader: 'css', minify: true, target: 'es6' })
    assert.strictEqual(code, `div{color:#abcd}\n`)
  },

  // Using a "node" target shouldn't affect CSS
  async cssMinifyTargetNode({ ezburn }) {
    const { code } = await ezburn.transform(`div { color: #abcd }`, { loader: 'css', minify: true, target: 'node8' })
    assert.strictEqual(code, `div{color:#abcd}\n`)
  },

  // Using an older browser target should affect CSS
  async cssMinifyTargetChrome8({ ezburn }) {
    const { code } = await ezburn.transform(`div { color: #abcd }`, { loader: 'css', minify: true, target: 'chrome8' })
    assert.strictEqual(code, `div{color:rgba(170,187,204,.867)}\n`)
  },

  // Using a newer browser target shouldn't affect CSS
  async cssMinifyTargetChrome80({ ezburn }) {
    const { code } = await ezburn.transform(`div { color: #abcd }`, { loader: 'css', minify: true, target: 'chrome80' })
    assert.strictEqual(code, `div{color:#abcd}\n`)
  },

  async cjs_require({ ezburn }) {
    const { code } = await ezburn.transform(`const {foo} = require('path')`, {})
    assert.strictEqual(code, `const { foo } = require("path");\n`)
  },

  async cjs_exports({ ezburn }) {
    const { code } = await ezburn.transform(`exports.foo = 123`, {})
    assert.strictEqual(code, `exports.foo = 123;\n`)
  },

  async es6_import({ ezburn }) {
    const { code } = await ezburn.transform(`import {foo} from 'path'`, {})
    assert.strictEqual(code, `import { foo } from "path";\n`)
  },

  async es6_export({ ezburn }) {
    const { code } = await ezburn.transform(`export const foo = 123`, {})
    assert.strictEqual(code, `export const foo = 123;\n`)
  },

  async es6_import_to_iife({ ezburn }) {
    const { code } = await ezburn.transform(`import {exists} from "fs"; if (!exists) throw 'fail'`, { format: 'iife' })
    new Function('require', code)(require)
  },

  async es6_import_star_to_iife({ ezburn }) {
    const { code } = await ezburn.transform(`import * as fs from "fs"; if (!fs.exists) throw 'fail'`, { format: 'iife' })
    new Function('require', code)(require)
  },

  async es6_export_to_iife({ ezburn }) {
    const { code } = await ezburn.transform(`export {exists} from "fs"`, { format: 'iife', globalName: 'out' })
    const out = new Function('require', code + ';return out')(require)
    if (out.exists !== fs.exists) throw 'fail'
  },

  async es6_export_star_to_iife({ ezburn }) {
    const { code } = await ezburn.transform(`export * from "fs"`, { format: 'iife', globalName: 'out' })
    const out = new Function('require', code + ';return out')(require)
    if (out.exists !== fs.exists) throw 'fail'
  },

  async es6_export_star_as_to_iife({ ezburn }) {
    const { code } = await ezburn.transform(`export * as fs from "fs"`, { format: 'iife', globalName: 'out' })
    const out = new Function('require', code + ';return out')(require)
    if (out.fs.exists !== fs.exists) throw 'fail'
  },

  async es6_import_to_cjs({ ezburn }) {
    const { code } = await ezburn.transform(`import {exists} from "fs"; if (!exists) throw 'fail'`, { format: 'cjs' })
    new Function('require', code)(require)
  },

  async es6_import_star_to_cjs({ ezburn }) {
    const { code } = await ezburn.transform(`import * as fs from "fs"; if (!fs.exists) throw 'fail'`, { format: 'cjs' })
    new Function('require', code)(require)
  },

  async es6_export_to_cjs({ ezburn }) {
    const { code } = await ezburn.transform(`export {exists} from "fs"`, { format: 'cjs' })
    const module = { exports: {} }
    new Function('module', 'exports', 'require', code)(module, module.exports, require)
    if (module.exports.exists !== fs.exists) throw 'fail'
  },

  async es6_export_star_to_cjs({ ezburn }) {
    const { code } = await ezburn.transform(`export * from "fs"`, { format: 'cjs' })
    const module = { exports: {} }
    new Function('module', 'exports', 'require', code)(module, module.exports, require)
    if (module.exports.exists !== fs.exists) throw 'fail'
  },

  async es6_export_star_as_to_cjs({ ezburn }) {
    const { code } = await ezburn.transform(`export * as fs from "fs"`, { format: 'cjs' })
    const module = { exports: {} }
    new Function('module', 'exports', 'require', code)(module, module.exports, require)
    if (module.exports.fs.exists !== fs.exists) throw 'fail'
  },

  async es6_import_to_esm({ ezburn }) {
    const { code } = await ezburn.transform(`import {exists} from "fs"; if (!exists) throw 'fail'`, { format: 'esm' })
    assert.strictEqual(code, `import { exists } from "fs";\nif (!exists) throw "fail";\n`)
  },

  async es6_import_star_to_esm({ ezburn }) {
    const { code } = await ezburn.transform(`import * as fs from "fs"; if (!fs.exists) throw 'fail'`, { format: 'esm' })
    assert.strictEqual(code, `import * as fs from "fs";\nif (!fs.exists) throw "fail";\n`)
  },

  async es6_export_to_esm({ ezburn }) {
    const { code } = await ezburn.transform(`export {exists} from "fs"`, { format: 'esm' })
    assert.strictEqual(code, `import { exists } from "fs";\nexport {\n  exists\n};\n`)
  },

  async es6_export_star_to_esm({ ezburn }) {
    const { code } = await ezburn.transform(`export * from "fs"`, { format: 'esm' })
    assert.strictEqual(code, `export * from "fs";\n`)
  },

  async es6_export_star_as_to_esm({ ezburn }) {
    const { code } = await ezburn.transform(`export * as fs from "fs"`, { format: 'esm' })
    assert.strictEqual(code, `import * as fs from "fs";\nexport {\n  fs\n};\n`)
  },

  async iifeGlobalName({ ezburn }) {
    const { code } = await ezburn.transform(`export default 123`, { format: 'iife', globalName: 'testName' })
    const globals = {}
  ...
  async iifeGlobalNameCompound({ ezburn }) {
    const { code } = await ezburn.transform(`export default 123`, { format: 'iife', globalName: 'test.name' })
    const globals = {}
    vm.createContext(globals)
    vm.runInContext(code, globals)
  ...
  async iifeGlobalNameString({ ezburn }) {
    const { code } = await ezburn.transform(`export default 123`, { format: 'iife', globalName: 'test["some text"]' })
    const globals = {}
    vm.createContext(globals)
    vm.runInContext(code, globals)
  ...
  async iifeGlobalNameUnicodeEscape({ ezburn }) {
    const { code } = await ezburn.transform(`export default 123`, { format: 'iife', globalName: 'π["π 𐀀"].𐀀["𐀀 π"]' })
    const globals = {}
    vm.createContext(globals)
    vm.runInContext(code, globals)
...
(((\\u03C0 ||= {})["\\u03C0 \\uD800\\uDC00"] ||= {})["\\uD800\\uDC00"] ||= {})["\\uD800\\uDC00 \\u03C0"] = `)
  ...
  async iifeGlobalNameUnicodeNoEscape({ ezburn }) {
    const { code } = await ezburn.transform(`export default 123`, { format: 'iife', globalName: 'π["π 𐀀"].𐀀["𐀀 π"]', charset: 'utf8' })
    const globals = {}
    vm.createContext(globals)
    vm.runInContext(code, globals)
    assert.strictEqual(globals.π["π 𐀀"].𐀀["𐀀 π"].default, 123)
...
(((π ||= {})["π 𐀀"] ||= {})["𐀀"] ||= {})["𐀀 π"] = `)
  ...
  async iifeGlobalNameUnicodeEscapeNoLogicalAssignment({ ezburn }) {
    const { code } = await ezburn.transform(`export default 123`, { format: 'iife', globalName: 'π["π 𐀀"].𐀀["𐀀 π"]', supported: { 'logical-assignment': false } })
    const globals = {}
    vm.createContext(globals)
    vm.runInContext(code, globals)
    assert.strictEqual(globals.π["π 𐀀"].𐀀["𐀀 π"].default, 123)
...
\\u03C0["\\u03C0 \\uD800\\uDC00"]["\\uD800\\uDC00"]["\\uD800\\uDC00 \\u03C0"] = `)
  ...
  async iifeGlobalNameUnicodeNoEscapeNoLogicalAssignment({ ezburn }) {
    const { code } = await ezburn.transform(`export default 123`, { format: 'iife', globalName: 'π["π 𐀀"].𐀀["𐀀 π"]', supported: { 'logical-assignment': false }, charset: 'utf8' })
    const globals = {}
    vm.createContext(globals)
    vm.runInContext(code, globals)
    assert.strictEqual(globals.π["π 𐀀"].𐀀["𐀀 π"].default, 123)
...
π["π 𐀀"]["𐀀"]["𐀀 π"] = `)
  ...
  async iifeGlobalNameThis({ ezburn }) {
    const { code } = await ezburn.transform(`export default 123`, { format: 'iife', globalName: 'this.foo.bar' })
    const globals = {}
    vm.createContext(globals)
    vm.runInContext(code, globals)
  ...
  async iifeGlobalNameImportMeta({ ezburn }) {
    const { code } = await ezburn.transform(`export default 123`, { format: 'iife', globalName: 'import.meta.foo.bar' })
  ...
  async jsx({ ezburn }) {
    const { code } = await ezburn.transform(`console.log(<div/>)`, { loader: 'jsx' })
    assert.strictEqual(code, `console.log(/* @__PURE__ */ React.createElement("div", null));\n`)
  },

  async jsxTransform({ ezburn }) {
    const { code } = await ezburn.transform(`console.log(<div/>)`, { loader: 'jsx', jsx: 'transform' })
    assert.strictEqual(code, `console.log(/* @__PURE__ */ React.createElement("div", null));\n`)
  },

  async jsxPreserve({ ezburn }) {
    const { code } = await ezburn.transform(`console.log(<div/>)`, { loader: 'jsx', jsx: 'preserve' })
    assert.strictEqual(code, `console.log(<div />);\n`)
  },

  async jsxRuntimeAutomatic({ ezburn }) {
    const { code } = await ezburn.transform(`console.log(<div/>)`, { loader: 'jsx', jsx: 'automatic' })
    assert.strictEqual(code, `import { jsx } from "react/jsx-runtime";\nconsole.log(/* @__PURE__ */ jsx("div", {}));\n`)
  },

  async jsxDev({ ezburn }) {
    const { code } = await ezburn.transform(`console.log(<div/>)`, { loader: 'jsx', jsx: 'automatic', jsxDev: true })
    assert.strictEqual(code, `import { jsxDEV } from "react/jsx-dev-runtime";\nconsole.log(/* @__PURE__ */ jsxDEV("div", {}, void 0, false, {\n  fileName: "<stdin>",\n  lineNumber: 1,\n  columnNumber: 13\n}, this));\n`)
  },

  async jsxImportSource({ ezburn }) {
    const { code } = await ezburn.transform(`console.log(<div/>)`, { loader: 'jsx', jsx: 'automatic', jsxImportSource: 'notreact' })
    assert.strictEqual(code, `import { jsx } from "notreact/jsx-runtime";\nconsole.log(/* @__PURE__ */ jsx("div", {}));\n`)
  },

  async jsxSideEffects({ ezburn }) {
    const { code } = await ezburn.transform(`<b/>`, { loader: 'jsx', jsxSideEffects: true })
    assert.strictEqual(code, `React.createElement("b", null);\n`)
  },

  async ts({ ezburn }) {
    const { code } = await ezburn.transform(`enum Foo { FOO }`, { loader: 'ts' })
    assert.strictEqual(code, `var Foo = /* @__PURE__ */ ((Foo2) => {\n  Foo2[Foo2["FOO"] = 0] = "FOO";\n  return Foo2;\n})(Foo || {});\n`)
  },

  async tsx({ ezburn }) {
    const { code } = await ezburn.transform(`console.log(<Foo<T>/>)`, { loader: 'tsx' })
    assert.strictEqual(code, `console.log(/* @__PURE__ */ React.createElement(Foo, null));\n`)
  },

  async minify({ ezburn }) {
    const { code } = await ezburn.transform(`console.log("a" + "b" + c)`, { minify: true })
    assert.strictEqual(code, `console.log("ab"+c);\n`)
  },

  async keepConsole({ ezburn }) {
    const { code } = await ezburn.transform(`console.log('foo')`, { drop: [] })
    assert.strictEqual(code, `console.log("foo");\n`)
  },

  async dropConsole({ ezburn }) {
    const { code: drop } = await ezburn.transform(`
      console.log('foo')
      console.log(foo())
    ...
    const { code: keepArrow } = await ezburn.transform(`
      console('foo')
      console.abc.xyz('foo')
      console['log']('foo')
      console[abc][xyz]('foo')
...
`)
    ...
    const { code: keepFn } = await ezburn.transform(`
      console('foo')
      console.abc.xyz('foo')
      console['log']('foo')
      console[abc][xyz]('foo')
...
`)
  ...
  async keepDebugger({ ezburn }) {
    const { code } = await ezburn.transform(`if (x) debugger`, { drop: [] })
    assert.strictEqual(code, `if (x) debugger;\n`)
  },

  async dropDebugger({ ezburn }) {
    const { code } = await ezburn.transform(`if (x) debugger`, { drop: ['debugger'] })
    assert.strictEqual(code, `if (x) ;\n`)
  },

  async defineProcessEnvNodeEnv({ ezburn }) {
    const define = { 'process.env.NODE_ENV': '"something"' }

    const { code: code1 } = await ezburn.transform(`console.log(process.env.NODE_ENV)`, { define })
    assert.strictEqual(code1, `console.log("something");\n`)

    const { code: code2 } = await ezburn.transform(`console.log(process.env['NODE_ENV'])`, { define })
    assert.strictEqual(code2, `console.log("something");\n`)

    const { code: code3 } = await ezburn.transform(`console.log(process['env'].NODE_ENV)`, { define })
    assert.strictEqual(code3, `console.log("something");\n`)

    const { code: code4 } = await ezburn.transform(`console.log(process['env']['NODE_ENV'])`, { define })
    assert.strictEqual(code4, `console.log("something");\n`)

    const { code: code5 } = await ezburn.transform(`console.log(process.env.NODE_ENV)`, {})
    assert.strictEqual(code5, `console.log(process.env.NODE_ENV);\n`)

    const { code: code6 } = await ezburn.transform(`console.log(process.env.NODE_ENV)`, { platform: 'browser' })
    assert.strictEqual(code6, `console.log(process.env.NODE_ENV);\n`)
  },

  async defineBuiltInConstants({ ezburn }) {
    const define = { a: 'NaN', b: 'Infinity', c: 'undefined', d: 'something', e: 'null' }
    const { code } = await ezburn.transform(`console.log([typeof a, typeof b, typeof c, typeof d, typeof e])`, { define })
    assert.strictEqual(code, `console.log(["number", "number", "undefined", typeof something, "object"]);\n`)
  },

  async defineArray({ ezburn }) {
    const define = { 'process.env.NODE_ENV': '[1,2,3]', 'something.else': '[2,3,4]' }
    const { code } = await ezburn.transform(`console.log(process.env.NODE_ENV)`, { define })
    assert.strictEqual(code, `var define_process_env_NODE_ENV_default = [1, 2, 3];\nconsole.log(define_process_env_NODE_ENV_default);\n`)
  },

  async defineThis({ ezburn }) {
    const { code: code1 } = await ezburn.transform(`console.log(a, b); export {}`, { define: { a: 'this', b: 'this.foo' }, format: 'esm' })
    assert.strictEqual(code1, `console.log(void 0, (void 0).foo);\n`)

    const { code: code2 } = await ezburn.transform(`console.log(this, this.x); export {}`, { define: { this: 'a', 'this.x': 'b' }, format: 'esm' })
    assert.strictEqual(code2, `console.log(a, b);\n`)
  },

  async defineImportMetaESM({ ezburn }) {
    const { code: code1 } = await ezburn.transform(`console.log(a, b); export {}`, { define: { a: 'import.meta', b: 'import.meta.foo' }, format: 'esm' })
    assert.strictEqual(code1, `console.log(import.meta, import.meta.foo);\n`)

    const { code: code2 } = await ezburn.transform(`console.log(import.meta, import.meta.x); export {}`, { define: { 'import.meta': 'a', 'import.meta.x': 'b' }, format: 'esm' })
    assert.strictEqual(code2, `console.log(a, b);\n`)
  },

  async defineImportMetaIIFE({ ezburn }) {
    const { code } = await ezburn.transform(`console.log(a, b); export {}`, { define: { a: 'import.meta', b: 'import.meta.foo' }, format: 'iife' })
    assert.strictEqual(code, `(() => {\n  const import_meta = {};\n  console.log(import_meta, import_meta.foo);\n})();\n`)
  },

  async defineIdentifierVsStringWarningIssue466Transform({ ezburn }) {
    const { warnings } = await ezburn.transform(``, { define: { 'process.env.NODE_ENV': 'production' } })
    const formatted = await ezburn.formatMessages(warnings, { kind: 'warning' })
...
`)
  ...
  async defineIdentifierVsStringWarningIssue466Build({ ezburn }) {
    const { warnings } = await ezburn.build({ define: { 'process.env.NODE_ENV': 'production' }, logLevel: 'silent' })
    const formatted = await ezburn.formatMessages(warnings, { kind: 'warning' })
    assert.strictEqual(formatted[0],
      `▲ [WARNING] "process.env.NODE_ENV" is defined as an identifier instead of a string (surround "production" with quotes to get a string) [suspicious-define]
...
`)
  ...
  async defineQuotedPropertyNameTransform({ ezburn }) {
    const { code: code1 } = await ezburn.transform(`return x.y['z!']`, { define: { 'x.y["z!"]': 'true' } })
    assert.strictEqual(code1, `return true;\n`)

    const { code: code2 } = await ezburn.transform(`foo(x['y'].z, x.y['z'], x['y']['z'])`, { define: { 'x.y.z': 'true' } })
    assert.strictEqual(code2, `foo(true, true, true);\n`)

    const { code: code3 } = await ezburn.transform(`foo(x['y'].z, x.y['z'], x['y']['z'])`, { define: { 'x["y"].z': 'true' } })
    assert.strictEqual(code3, `foo(true, true, true);\n`)

    const { code: code4 } = await ezburn.transform(`foo(x['y'].z, x.y['z'], x['y']['z'])`, { define: { 'x.y["z"]': 'true' } })
    assert.strictEqual(code4, `foo(true, true, true);\n`)

    const { code: code5 } = await ezburn.transform(`foo(x['y'].z, x.y['z'], x['y']['z'])`, { define: { 'x["y"][\'z\']': 'true' } })
    assert.strictEqual(code5, `foo(true, true, true);\n`)

    const { code: code6 } = await ezburn.transform(`foo(import.meta['y'].z, import.meta.y['z'], import.meta['y']['z'])`, { define: { 'import.meta["y"].z': 'true' } })
    assert.strictEqual(code6, `foo(true, true, true);\n`)

    const { code: code7 } = await ezburn.transform(`foo(import.meta['y!'].z, import.meta.y['z!'], import.meta['y!']['z!'])`, {
      define: {
  ...
  async defineQuotedPropertyNameBuild({ ezburn }) {
    const { outputFiles } = await ezburn.build({
  ...
  async defineBigInt({ ezburn }) {
    const { code } = await ezburn.transform(`console.log(a, b); export {}`, { define: { a: '0n', b: '{"x":[123n]}' }, format: 'esm' })
    assert.strictEqual(code, `var define_b_default = { x: [123n] };\nconsole.log(0n, define_b_default);\n`)
  },

  async json({ ezburn }) {
    const { code } = await ezburn.transform(`{ "x": "y" }`, { loader: 'json' })
    assert.strictEqual(code, `module.exports = { x: "y" };\n`)
  },

  async jsonMinified({ ezburn }) {
    const { code } = await ezburn.transform(`{ "x": "y" }`, { loader: 'json', minify: true })
    const module = {}
    new Function('module', code)(module)
    assert.deepStrictEqual(module.exports, { x: 'y' })
  },

  async jsonESM({ ezburn }) {
    const { code } = await ezburn.transform(`{ "x": "y" }`, { loader: 'json', format: 'esm' })
    assert.strictEqual(code, `var x = "y";\nvar stdin_default = { x };\nexport {\n  stdin_default as default,\n  x\n};\n`)
  },

  async jsonInvalidIdentifierStart({ ezburn }) {
    // This character is a valid "ID_Continue" but not a valid "ID_Start" so it must be quoted
    const { code } = await ezburn.transform(`{ "\\uD835\\uDFCE": "y" }`, { loader: 'json' })
    assert.strictEqual(code, `module.exports = { "\\u{1D7CE}": "y" };\n`)
  },

  async text({ ezburn }) {
    const { code } = await ezburn.transform(`This is some text`, { loader: 'text' })
    assert.strictEqual(code, `module.exports = "This is some text";\n`)
  },

  async textESM({ ezburn }) {
    const { code } = await ezburn.transform(`This is some text`, { loader: 'text', format: 'esm' })
    assert.strictEqual(code, `var stdin_default = "This is some text";\nexport {\n  stdin_default as default\n};\n`)
  },

  async base64({ ezburn }) {
    const { code } = await ezburn.transform(`\x00\x01\x02`, { loader: 'base64' })
    assert.strictEqual(code, `module.exports = "AAEC";\n`)
  },

  async dataurl({ ezburn }) {
    const { code: code1 } = await ezburn.transform(`\x00\x01\x02`, { loader: 'dataurl' })
    assert.strictEqual(code1, `module.exports = "data:application/octet-stream,%00%01%02";\n`)

    const { code: code2 } = await ezburn.transform(`\xFD\xFE\xFF`, { loader: 'dataurl' })
    assert.strictEqual(code2, `module.exports = "data:text/plain;charset=utf-8,\\xFD\\xFE\\xFF";\n`)

    const { code: code3 } = await ezburn.transform(new Uint8Array([0xFD, 0xFE, 0xFF]), { loader: 'dataurl' })
    assert.strictEqual(code3, `module.exports = "data:text/plain;charset=utf-8;base64,/f7/";\n`)
  },

  async sourceMapTrueWithName({ ezburn }) {
    const { code, map } = await ezburn.transform(`let       x`, { sourcemap: true, sourcefile: 'afile.js' })
    assert.strictEqual(code, `let x;\n`)
    await assertSourceMap(map, 'afile.js')
  },

  async sourceMapLinkedWithName({ ezburn }) {
    try {
      await ezburn.transform(`let       x`, { sourcemap: 'linked', sourcefile: 'afile.js' })
      throw new Error('Expected a transform failure')
    } catch (e) {
  ...
  async sourceMapExternalWithName({ ezburn }) {
    const { code, map } = await ezburn.transform(`let       x`, { sourcemap: 'external', sourcefile: 'afile.js' })
    assert.strictEqual(code, `let x;\n`)
    await assertSourceMap(map, 'afile.js')
  },

  async sourceMapInlineWithName({ ezburn }) {
    const { code, map } = await ezburn.transform(`let       x`, { sourcemap: 'inline', sourcefile: 'afile.js' })
  ...
  async sourceMapBothWithName({ ezburn }) {
    const { code, map } = await ezburn.transform(`let       x`, { sourcemap: 'both', sourcefile: 'afile.js' })
    assert(code.startsWith(`let x;\n//# sourceMappingURL=`))
    await assertSourceMap(map, 'afile.js')
    const base64 = code.slice(code.indexOf('base64,') + 'base64,'.length)
    await assertSourceMap(Buffer.from(base64.trim(), 'base64').toString(), 'afile.js')
  ...
  async sourceMapRoot({ ezburn }) {
    const { code, map } = await ezburn.transform(`let       x`, { sourcemap: true, sourcefile: 'afile.js', sourceRoot: "https://example.com/" })
    assert.strictEqual(code, `let x;\n`)
    assert.strictEqual(JSON.parse(map).sourceRoot, 'https://example.com/');
  },

  async numericLiteralPrinting({ ezburn }) {
    async function checkLiteral(text) {
      const { code } = await ezburn.transform(`return ${text}`, { minify: true })
  ...
  async tryCatchScopeMerge({ ezburn }) {
    const code = `
      var x = 1
      if (x !== 1) throw 'fail'
      try {
    ...
    new Function((await ezburn.transform(code)).code)();
  },

  async nestedFunctionHoist({ ezburn }) {
    const code = `
  ...
  async nestedFunctionHoistBefore({ ezburn }) {
    const code = `
      var x = 1
      if (x !== 1) throw 'fail'
      {
  ...
  async nestedFunctionHoistAfter({ ezburn }) {
    const code = `
      if (x !== void 0) throw 'fail'
      {
        if (x !== void 0) throw 'fail'
  ...
  async nestedFunctionShadowBefore({ ezburn }) {
    const code = `
      let x = 1
      if (x !== 1) throw 'fail'
      {
  ...
  async nestedFunctionShadowAfter({ ezburn }) {
    const code = `
  ...
  async sourceMapControlCharacterEscapes({ ezburn }) {
    let chars = ''
  ...
  async transformLegalCommentsCSS({ ezburn }) {
  ...
  async pureCallPrint({ ezburn }) {
    const { code: code1 } = await ezburn.transform(`print(123, foo)`, { minifySyntax: true, pure: [] })
    assert.strictEqual(code1, `print(123, foo);\n`)

    const { code: code2 } = await ezburn.transform(`print(123, foo)`, { minifySyntax: true, pure: ['print'] })
    assert.strictEqual(code2, `foo;\n`)
  },

  async pureCallConsoleLog({ ezburn }) {
    const { code: code1 } = await ezburn.transform(`console.log(123, foo)`, { minifySyntax: true, pure: [] })
    assert.strictEqual(code1, `console.log(123, foo);\n`)

    const { code: code2 } = await ezburn.transform(`console.log(123, foo)`, { minifySyntax: true, pure: ['console.log'] })
    assert.strictEqual(code2, `foo;\n`)
  },

  async pureImportMeta({ ezburn }) {
    const { code: code1 } = await ezburn.transform(`import.meta.foo(123, foo)`, { minifySyntax: true, pure: [] })
    assert.strictEqual(code1, `import.meta.foo(123, foo);\n`)

    const { code: code2 } = await ezburn.transform(`import.meta.foo(123, foo)`, { minifySyntax: true, pure: ['import.meta.foo'] })
    assert.strictEqual(code2, `foo;\n`)
  },

  async nameCollisionEvalRename({ ezburn }) {
    const { code } = await ezburn.transform(`
  ...
  async nameCollisionEvalMinify({ ezburn }) {
    const { code } = await ezburn.transform(`
  ...
  async singleUseExpressionSubstitution({ ezburn }) {
    function run(code) {
      try {
    ...
    for (let input of [
      ...
      const { code: minified } = await ezburn.transform(input, { minify: true })
      if (run(input) !== run(minified)) bugs += '\n  ' + input
    }
    if (bugs !== '') throw new Error('Single-use expression substitution bugs:' + bugs)
  },

  async platformNode({ ezburn }) {
    const { code } = await ezburn.transform(`export let foo = 123`, { format: 'cjs', platform: 'node' })
...
`)
  ...
  async dynamicImportString({ ezburn }) {
    const { code } = await ezburn.transform(`import('foo')`, { target: 'chrome63' })
    assert.strictEqual(code, `import("foo");\n`)
  },

  async dynamicImportStringES6({ ezburn }) {
    const fromPromiseResolve = text => text.slice(text.indexOf('Promise.resolve'))
    const { code } = await ezburn.transform(`import('foo')`, { target: 'chrome62' })
    assert.strictEqual(fromPromiseResolve(code), `Promise.resolve().then(() => __toESM(require("foo")));\n`)
  },

  async dynamicImportStringES5({ ezburn }) {
    const fromPromiseResolve = text => text.slice(text.indexOf('Promise.resolve'))
    const { code } = await ezburn.transform(`import('foo')`, { target: 'chrome48' })
    assert.strictEqual(fromPromiseResolve(code), `Promise.resolve().then(function() {\n  return __toESM(require("foo"));\n});\n`)
  },

  async dynamicImportStringES5Minify({ ezburn }) {
    const fromPromiseResolve = text => text.slice(text.indexOf('Promise.resolve'))
    const { code } = await ezburn.transform(`import('foo')`, { target: 'chrome48', minifyWhitespace: true })
    assert.strictEqual(fromPromiseResolve(code), `Promise.resolve().then(function(){return __toESM(require("foo"))});\n`)
  },

  async dynamicImportStringNode12_19({ ezburn }) {
    const fromPromiseResolve = text => text.slice(text.indexOf('Promise.resolve'))
    const { code } = await ezburn.transform(`import('foo')`, { target: 'node12.19' })
    assert.strictEqual(fromPromiseResolve(code), `Promise.resolve().then(() => __toESM(require("foo")));\n`)
  },

  async dynamicImportStringNode12_20({ ezburn }) {
    const { code } = await ezburn.transform(`import('foo')`, { target: 'node12.20' })
    assert.strictEqual(code, `import("foo");\n`)
  },

  async dynamicImportStringNode13({ ezburn }) {
    const fromPromiseResolve = text => text.slice(text.indexOf('Promise.resolve'))
    const { code } = await ezburn.transform(`import('foo')`, { target: 'node13' })
    assert.strictEqual(fromPromiseResolve(code), `Promise.resolve().then(() => __toESM(require("foo")));\n`)
  },

  async dynamicImportStringNode13_1({ ezburn }) {
    const fromPromiseResolve = text => text.slice(text.indexOf('Promise.resolve'))
    const { code } = await ezburn.transform(`import('foo')`, { target: 'node13.1' })
    assert.strictEqual(fromPromiseResolve(code), `Promise.resolve().then(() => __toESM(require("foo")));\n`)
  },

  async dynamicImportStringNode13_2({ ezburn }) {
    const { code } = await ezburn.transform(`import('foo')`, { target: 'node13.2' })
    assert.strictEqual(code, `import("foo");\n`)
  },

  async dynamicImportExpression({ ezburn }) {
    const { code } = await ezburn.transform(`import(foo)`, { target: 'chrome63' })
    assert.strictEqual(code, `import(foo);\n`)
  },

  async dynamicImportExpressionES6({ ezburn }) {
    const fromPromiseResolve = text => text.slice(text.indexOf('Promise.resolve'))
    const { code: code2 } = await ezburn.transform(`import(foo)`, { target: 'chrome62' })
    assert.strictEqual(fromPromiseResolve(code2), `Promise.resolve().then(() => __toESM(require(foo)));\n`)
  },

  async dynamicImportExpressionES5({ ezburn }) {
    const fromPromiseResolve = text => text.slice(text.indexOf('Promise.resolve'))
    const { code: code3 } = await ezburn.transform(`import(foo)`, { target: 'chrome48' })
    assert.strictEqual(fromPromiseResolve(code3), `Promise.resolve().then(function() {\n  return __toESM(require(foo));\n});\n`)
  },

  async dynamicImportExpressionES5Minify({ ezburn }) {
    const fromPromiseResolve = text => text.slice(text.indexOf('Promise.resolve'))
    const { code: code4 } = await ezburn.transform(`import(foo)`, { target: 'chrome48', minifyWhitespace: true })
    assert.strictEqual(fromPromiseResolve(code4), `Promise.resolve().then(function(){return __toESM(require(foo))});\n`)
  },

  async classStaticBlocks({ ezburn }) {
    // Check that empty static class blocks are still lowered (this was a regression in version 0.18.2)
    assert.strictEqual((await ezburn.transform(`class Foo { static {} }`, { supported: { 'class-static-blocks': false } })).code, `class Foo {\n}\n`)
    assert.strictEqual((await ezburn.transform(`class Foo { static { x } }`, { supported: { 'class-static-blocks': false } })).code, `class Foo {\n}\nx;\n`)
  },

  async keepNamesUnsupported({ ezburn }) {
    try {
      await ezburn.transform(``, { keepNames: true, target: 'chrome36' })
      throw new Error('Expected an error to be thrown')
    } catch (e) {
    ...
    try {
      await ezburn.transform(``, { keepNames: true, target: 'chrome46', supported: { 'function-name-configurable': false } })
      throw new Error('Expected an error to be thrown')
    } catch (e) {
      assert.strictEqual(e.errors[0].text,
    ...
    await ezburn.transform(``, { keepNames: true, target: 'chrome46' })
  },

  async inlineScript({ ezburn }) {
    let p
    assert.strictEqual((await ezburn.transform(`x = '</script>'`, {})).code, `x = "<\\/script>";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script> inline'`, { supported: { 'inline-script': true } })).code, `x = "<\\/script> inline";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script> noinline'`, { supported: { 'inline-script': false } })).code, `x = "</script> noinline";\n`)

    p = { platform: 'browser' }
    assert.strictEqual((await ezburn.transform(`x = '</script> browser'`, { ...p })).code, `x = "<\\/script> browser";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script> browser inline'`, { ...p, supported: { 'inline-script': true } })).code, `x = "<\\/script> browser inline";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script> browser noinline'`, { ...p, supported: { 'inline-script': false } })).code, `x = "</script> browser noinline";\n`)

    p = { platform: 'node' }
    assert.strictEqual((await ezburn.transform(`x = '</script> node'`, { ...p })).code, `x = "</script> node";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script> node inline'`, { ...p, supported: { 'inline-script': true } })).code, `x = "<\\/script> node inline";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script> node noinline'`, { ...p, supported: { 'inline-script': false } })).code, `x = "</script> node noinline";\n`)

    p = { platform: 'neutral' }
    assert.strictEqual((await ezburn.transform(`x = '</script> neutral'`, { ...p })).code, `x = "</script> neutral";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script> neutral inline'`, { ...p, supported: { 'inline-script': true } })).code, `x = "<\\/script> neutral inline";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script> neutral noinline'`, { ...p, supported: { 'inline-script': false } })).code, `x = "</script> neutral noinline";\n`)

    assert.strictEqual((await ezburn.transform(`x = '</script>'`, { target: 'esnext' })).code, `x = "<\\/script>";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script>'`, { target: 'es2020' })).code, `x = "<\\/script>";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script>'`, { target: 'es6' })).code, `x = "<\\/script>";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script>'`, { target: 'chrome999' })).code, `x = "<\\/script>";\n`)
    assert.strictEqual((await ezburn.transform(`x = '</script>'`, { target: 'chrome0' })).code, `x = "<\\/script>";\n`)
  },

  async inlineStyle({ ezburn }) {
    let p = { loader: 'css' }
    assert.strictEqual((await ezburn.transform(`x { y: '</style>' }`, { ...p })).code, `x {\n  y: "<\\/style>";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style> inline' }`, { ...p, supported: { 'inline-style': true } })).code, `x {\n  y: "<\\/style> inline";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style> noinline' }`, { ...p, supported: { 'inline-style': false } })).code, `x {\n  y: "</style> noinline";\n}\n`)

    p = { loader: 'css', platform: 'browser' }
    assert.strictEqual((await ezburn.transform(`x { y: '</style> browser' }`, { ...p })).code, `x {\n  y: "<\\/style> browser";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style> browser inline' }`, { ...p, supported: { 'inline-style': true } })).code, `x {\n  y: "<\\/style> browser inline";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style> browser noinline' }`, { ...p, supported: { 'inline-style': false } })).code, `x {\n  y: "</style> browser noinline";\n}\n`)

    p = { loader: 'css', platform: 'node' }
    assert.strictEqual((await ezburn.transform(`x { y: '</style> node' }`, { ...p })).code, `x {\n  y: "</style> node";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style> node inline' }`, { ...p, supported: { 'inline-style': true } })).code, `x {\n  y: "<\\/style> node inline";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style> node noinline' }`, { ...p, supported: { 'inline-style': false } })).code, `x {\n  y: "</style> node noinline";\n}\n`)

    p = { loader: 'css', platform: 'neutral' }
    assert.strictEqual((await ezburn.transform(`x { y: '</style> neutral' }`, { ...p })).code, `x {\n  y: "</style> neutral";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style> neutral inline' }`, { ...p, supported: { 'inline-style': true } })).code, `x {\n  y: "<\\/style> neutral inline";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style> neutral noinline' }`, { ...p, supported: { 'inline-style': false } })).code, `x {\n  y: "</style> neutral noinline";\n}\n`)

    p = { loader: 'css' }
    assert.strictEqual((await ezburn.transform(`x { y: '</style>' }`, { ...p, target: 'esnext' })).code, `x {\n  y: "<\\/style>";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style>' }`, { ...p, target: 'es2020' })).code, `x {\n  y: "<\\/style>";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style>' }`, { ...p, target: 'es6' })).code, `x {\n  y: "<\\/style>";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style>' }`, { ...p, target: 'chrome999' })).code, `x {\n  y: "<\\/style>";\n}\n`)
    assert.strictEqual((await ezburn.transform(`x { y: '</style>' }`, { ...p, target: 'chrome0' })).code, `x {\n  y: "<\\/style>";\n}\n`)
  },

  async typeofEqualsUndefinedTarget({ ezburn }) {
    assert.strictEqual((await ezburn.transform(`a = typeof b !== 'undefined'`, { minify: true })).code, `a=typeof b<"u";\n`)
    assert.strictEqual((await ezburn.transform(`a = typeof b !== 'undefined'`, { minify: true, target: 'es2020' })).code, `a=typeof b<"u";\n`)
    assert.strictEqual((await ezburn.transform(`a = typeof b !== 'undefined'`, { minify: true, target: 'chrome11' })).code, `a=typeof b<"u";\n`)

    assert.strictEqual((await ezburn.transform(`a = typeof b !== 'undefined'`, { minify: true, target: 'es2019' })).code, `a=typeof b!="undefined";\n`)
    assert.strictEqual((await ezburn.transform(`a = typeof b !== 'undefined'`, { minify: true, target: 'ie11' })).code, `a=typeof b!="undefined";\n`)
  },

  async caseInsensitiveTarget({ ezburn }) {
    assert.strictEqual((await ezburn.transform(`a ||= b`, { target: 'eS5' })).code, `a || (a = b);\n`)
    assert.strictEqual((await ezburn.transform(`a ||= b`, { target: 'eSnExT' })).code, `a ||= b;\n`)
  },

  async propertyAccessBugWorkaroundForWebKit({ ezburn }) {
    const check = async (target, input, expected) =>
      assert.strictEqual((await ezburn.transform(input, { target })).code, expected)
    await Promise.all([
  ...
  async multipleEngineTargets({ ezburn }) {
    const check = async (target, expected) =>
      assert.strictEqual((await ezburn.transform(`foo(a ?? b)`, { target })).code, expected)
    await Promise.all([
  ...
  async multipleEngineTargetsNotSupported({ ezburn }) {
    try {
      await ezburn.transform(`class X {}`, { target: ['es5', 'chrome1', 'safari2', 'firefox3'] })
      throw new Error('Expected an error to be thrown')
    } catch (e) {
      assert.strictEqual(e.errors[0].text,
  ...
  async supported({ ezburn }) {
    const check = async (options, input, expected) => {
      try {
        assert.strictEqual((await ezburn.transform(input, options)).code, expected)
      } catch (e) {
  ...
  // Future syntax
  nonIdArrayRest: ({ ezburn }) => futureSyntax(ezburn, 'let [...[x]] = y', 'es2015', 'es2016'),
  topLevelAwait: ({ ezburn }) => futureSyntax(ezburn, 'await foo', 'es2020', 'esnext'),
  topLevelForAwait: ({ ezburn }) => futureSyntax(ezburn, 'for await (foo of bar) ;', 'es2020', 'esnext'),
}
...
function registerClassPrivateTests(target) {
  ...
  transformTests[`transformClassPrivate_${target[0]}`] = async ({ ezburn }) =>
    new Function((await ezburn.transform(contents, { target })).code)()
  buildTests[`buildClassPrivate_${target[0]}`] = async ({ ezburn }) =>
    new Function((await ezburn.build(buildOptions)).outputFiles[0].text)()
  ...
  transformTests[`tsTransformClassPrivate_${target[0]}`] = async ({ ezburn }) =>
    new Function((await ezburn.transform(contents, { target, loader: 'ts' })).code)()
  buildTests[`tsBuildClassPrivate_${target[0]}`] = async ({ ezburn }) =>
    new Function((await ezburn.build(buildOptionsTS)).outputFiles[0].text)()
}
...
let formatTests = {
  async formatMessages({ ezburn }) {
    const messages = await ezburn.formatMessages([
...
let analyzeTests = {
  async analyzeMetafile({ ezburn }) {
    ...
    assert.strictEqual(await ezburn.analyzeMetafile(metafile), `
  out.js       100b   100.0%
   ├ lib.js     50b    50.0%
   └ entry.js   25b    25.0%
`)
    assert.strictEqual(await ezburn.analyzeMetafile(metafile, { verbose: true }), `
  out.js ────── 100b ── 100.0%
   ├ lib.js ──── 50b ─── 50.0%
   │  └ entry.js
   └ entry.js ── 25b ─── 25.0%
...

{
  ...
  for (let kind of ['var', 'let', 'const']) {
    for (let code of functionScopeCases) {
      ...
      transformTests['functionScope' + counter++] = async ({ ezburn }) => {
        let ezburnError
        let nodeError
        try { await ezburn.transform(code) } catch (e) { ezburnError = e }
        try { new Function(code)() } catch (e) { nodeError = e }
        if (!ezburnError !== !nodeError) {
          throw new Error(`
            code: ${code}
            ezburn: ${ezburnError}
            node: ${nodeError}
...
let apiSyncTests = {
  async defaultExport({ ezburn }) {
    assert.strictEqual(typeof ezburn.version, 'string')
    assert.strictEqual(ezburn.version, ezburn.default.version)
    assert.strictEqual(ezburn.version, ezburn.default.default.version)
    assert.strictEqual(ezburn.version, ezburn.default.default.default.version)
  },

  async buildSync({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, 'export default 123')
    ezburn.buildSync({ entryPoints: [input], bundle: true, outfile: output, format: 'cjs' })
    const result = require(output)
    assert.strictEqual(result.default, 123)
    assert.strictEqual(result.__esModule, true)
  },

  async buildSyncOutputFiles({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, 'module.exports = 123')
    let prettyPath = path.relative(process.cwd(), input).split(path.sep).join('/')
    let text = `// ${prettyPath}\nmodule.exports = 123;\n`
    let result = ezburn.buildSync({ entryPoints: [input], bundle: true, outfile: output, format: 'cjs', write: false })
    assert.strictEqual(result.outputFiles.length, 1)
  ...
  async transformSyncJSMap({ ezburn }) {
    const { code, map } = ezburn.transformSync(`1+2`, { sourcemap: true })
...
`)
  ...
  async transformSyncJSMapNoContent({ ezburn }) {
    const { code, map } = ezburn.transformSync(`1+2`, { sourcemap: true, sourcesContent: false })
    assert.strictEqual(code, `1 + 2;\n`)
    assert.strictEqual(map, `{
  "version": 3,
  "sources": ["<stdin>"],
...
`)
  ...
  async transformSyncCSS({ ezburn }) {
    const { code, map } = ezburn.transformSync(`a{b:c}`, { loader: 'css' })
    assert.strictEqual(code, `a {\n  b: c;\n}\n`)
    assert.strictEqual(map, '')
  },

  async transformSyncWithNonString({ ezburn }) {
    try {
      ezburn.transformSync(Object.create({ toString() { return '1+2' } }))
      throw new Error('Expected an error to be thrown');
    } catch (e) {
      assert.strictEqual(e.errors ? e.errors[0].text : e + '', 'The input to "transform" must be a string or a Uint8Array')
    }
  ...
  async transformSync100x({ ezburn }) {
    for (let i = 0; i < 100; i++) {
      const { code } = ezburn.transformSync(`console.log(1+${i})`, {})
      assert.strictEqual(code, `console.log(1 + ${i});\n`)
    }
  },

  async buildSyncThrow({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    try {
      const output = path.join(testDir, 'out.js')
      await writeFileAsync(input, '1+')
      ezburn.buildSync({ entryPoints: [input], bundle: true, outfile: output, format: 'cjs', logLevel: 'silent' })
      const result = require(output)
      assert.strictEqual(result.default, 123)
      assert.strictEqual(result.__esModule, true)
      throw new Error('Expected an error to be thrown');
...
${path.relative(process.cwd(), input).split(path.sep).join('/')}:1:2: ERROR: Unexpected end of file`);
  ...
  async transformThrow({ ezburn }) {
    try {
      await ezburn.transform(`1+`, {})
      throw new Error('Expected an error to be thrown');
    } catch (error) {
      assert(error instanceof Error, 'Must be an Error object');
  ...
  async formatMessagesSync({ ezburn }) {
    const messages = ezburn.formatMessagesSync([
      { text: 'This is an error' },
      { text: 'Another error', location: { file: 'file.js' } },
    ], {
      kind: 'error',
  ...
  async analyzeMetafileSync({ ezburn }) {
    const metafile = {
      "inputs": {
        "entry.js": {
          "bytes": 50,
    ...
    assert.strictEqual(ezburn.analyzeMetafileSync(metafile), `
  out.js       100b   100.0%
   ├ lib.js     50b    50.0%
   └ entry.js   25b    25.0%
`)
    assert.strictEqual(ezburn.analyzeMetafileSync(metafile, { verbose: true }), `
  out.js ────── 100b ── 100.0%
   ├ lib.js ──── 50b ─── 50.0%
   │  └ entry.js
   └ entry.js ── 25b ─── 25.0%
...
let childProcessTests = {
  // More info about this test case: https://github.com/khulnasoft/ezburn/issues/2727
  async testIncrementalChildProcessExit({ testDir, ezburn }) {
    const file = path.join(testDir, 'build.js')

    await writeFileAsync(file, `
      const ezburn = require(${JSON.stringify(ezburn.EZBURN_PACKAGE_PATH)})
      ezburn.context({
        entryPoints: [],
      })
  ...
  async testWatchStdoutChildProcess({ testDir, ezburn }) {
    const sequence = [
      {
...
let serialTests = {
  async startStop({ ezburn }) {
    for (let i = 0; i < 3; i++) {
      let result1 = await ezburn.transform('1+2')
      assert.strictEqual(result1.code, '1 + 2;\n')

      let result2 = ezburn.transformSync('2+3')
      assert.strictEqual(result2.code, '2 + 3;\n')

      let result3 = await ezburn.build({ stdin: { contents: '1+2' }, write: false })
      assert.strictEqual(result3.outputFiles[0].text, '1 + 2;\n')

      let result4 = ezburn.buildSync({ stdin: { contents: '2+3' }, write: false })
