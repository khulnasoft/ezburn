...
const { buildBinary, dirname, removeRecursiveSync, writeFileAtomic } = require('./ezburn.js')
...
// Test bogus paths with a file as a parent directory (this happens when you use "pnpx ezburn")
tests.push(
...
tests.push(
  ...
  // https://github.com/khulnasoft/ezburn/issues/3205
  ...
  // https://github.com/khulnasoft/ezburn/issues/3210
...
tests.push(
  // See: https://github.com/khulnasoft/ezburn/issues/2481
  ...
  // See: https://github.com/khulnasoft/ezburn/issues/3767
...
if (process.platform !== 'win32') {
  tests.push(
    ...
    // This is a test for https://github.com/khulnasoft/ezburn/issues/222
    ...
    // This is a test for https://github.com/khulnasoft/ezburn/issues/766
    ...
    // These tests are for https://github.com/khulnasoft/ezburn/issues/2773
    test(['--bundle', 'in.js', '--outfile=node.js'], {
...
// https://github.com/khulnasoft/ezburn/issues/956
tests.push(
...
// https://github.com/khulnasoft/ezburn/issues/1017
...
tests.push(
  // See https://github.com/khulnasoft/ezburn/issues/421
  test(['--bundle', 'in.js', '--outfile=node.js'], {
    'in.js': `
      import {foo} from './cjs'
      import {bar} from './esm'
  ...
  // See https://github.com/khulnasoft/ezburn/issues/542
...
tests.push(
  ...
  // Complex circular bundled and non-bundled import case (https://github.com/khulnasoft/ezburn/issues/758)
  test(['node.ts', '--bundle', '--format=cjs', '--outdir=.'], {
    'node.ts': `
  ...
  // Failure case due to a bug in https://github.com/khulnasoft/ezburn/pull/2059
...
for (const minify of [[], ['--minify']]) {
  ...
  tests.push(
    ...
    // https://github.com/khulnasoft/ezburn/issues/2793
...
tests.push(
  ...
  You can read more about direct eval and bundling here: https://ezburn.github.io/link/direct-eval
...
tests.push(
  ...
  // https://github.com/khulnasoft/ezburn/issues/1890
  ...
  test(['--bundle', 'foo.js', '--outfile=out.js', '--format=cjs', '--platform=node'], {
    'foo.js': `
      export function confuseNode(exports) {
        ...
        // https://github.com/khulnasoft/ezburn/issues/3544
...
tests.push(
  ...
  // https://github.com/khulnasoft/ezburn/issues/3029
  test([
...
// https://github.com/khulnasoft/ezburn/issues/1082
tests.push(
...
// Context: https://github.com/khulnasoft/ezburn/pull/1236
tests.push(
...
// https://github.com/khulnasoft/ezburn/issues/1080
tests.push(
...
// https://github.com/khulnasoft/ezburn/issues/1088
...
tests.push(
  ...
  // https://github.com/khulnasoft/ezburn/issues/1812
  test(['in.js', '--outfile=node.js'], {
    'in.js': `
      let a = 1;
      let def = "PASS2";
...
for (const minify of [[], ['--minify-syntax']]) {
  tests.push(
    ...
    // See: https://github.com/khulnasoft/ezburn/issues/3195
  ...
  // https://github.com/khulnasoft/ezburn/issues/3125
  tests.push(
    test(['in.js', '--outfile=node.js'].concat(minify), {
      'in.js': `
        let y
  ...
  // https://github.com/khulnasoft/ezburn/issues/3700
  tests.push(
...
for (let flags of [[], ['--minify', '--keep-names']]) {
  tests.push(
    ...
    // See: https://github.com/khulnasoft/ezburn/issues/3199
    ...
    // See: https://github.com/khulnasoft/ezburn/issues/3756
    test(['in.js', '--outfile=node.js', '--bundle'].concat(flags), {
...
tests.push(
  ...
  // https://github.com/khulnasoft/ezburn/issues/2149
...
// nested function declarations: https://github.com/khulnasoft/ezburn/issues/2809.
// Previously ezburn generated the following code:
//
//   let f = 0;
//   for (let l of [1, 2]) {
//     let t = function(o) {
...
// see: https://github.com/khulnasoft/ezburn/issues/1455.
tests.push(
  test(['in.js', '--outfile=node.js', '--bundle'], {
    'in.js': `
...
tests.push(
  ...
  // Test for an implicit and explicit "**/" prefix (see https://github.com/khulnasoft/ezburn/issues/1184)
  test(['--bundle', 'entry.js', '--outfile=node.js'], {
...
for (let flags of [['--target=es2022'], ['--target=es6'], ['--bundle', '--target=es2022'], ['--bundle', '--target=es6']]) {
  ...
  // here and ezburn is correct, both because SpiderMonkey and JavaScriptCore
    ...
    test(['in.js', '--outfile=node.js'].concat(flags), {
      'in.js': `
        function expect(fn, msg) {
          ...
          // Only check the exact error message for ezburn
...
`,
    ...
    // Issue: https://github.com/khulnasoft/ezburn/issues/901
    test(['in.js', '--outfile=node.js'].concat(flags), {
      'in.js': `
        class A {
          pub = this.#priv;
    ...
    // Issue: https://github.com/khulnasoft/ezburn/issues/1066
    test(['in.js', '--outfile=node.js'].concat(flags), {
      'in.js': `
        class Test {
          #x = 2;
    ...
    // https://github.com/khulnasoft/ezburn/issues/2800
    test(['in.js', '--outfile=node.js'].concat(flags), {
      'in.js': `
        class Baz {
          static thing = "value"
    ...
    // https://github.com/khulnasoft/ezburn/issues/2950
    test(['in.js', '--outfile=node.js'].concat(flags), {
      'in.js': `
        class SomeClass {
          static { this.One = 1; }
    ...
    // https://github.com/khulnasoft/ezburn/issues/3025
    test(['in.js', '--outfile=node.js'].concat(flags), {
      'in.js': `
        class Foo {
          static {
    ...
    // https://github.com/khulnasoft/ezburn/issues/2389
    ...
    // https://github.com/khulnasoft/ezburn/issues/2629
    test(['in.ts', '--outfile=node.js'].concat(flags), {
      'in.ts': `
    ...
    // https://github.com/khulnasoft/ezburn/issues/2045
    ...
    // https://github.com/khulnasoft/ezburn/issues/3326
    test(['in.ts', '--outfile=node.js'].concat(flags), {
      'in.ts': `
        const log: string[] = []
        class Test1 {
    ...
    // https://github.com/khulnasoft/ezburn/issues/3394
    test(['in.ts', '--outfile=node.js'].concat(flags), {
      'in.ts': `
    ...
    // https://github.com/khulnasoft/ezburn/issues/3538
    test(['in.js', '--outfile=node.js'].concat(flags), {
      'in.js': `
    ...
    // https://github.com/khulnasoft/ezburn/issues/3559
    test(['in.ts', '--outfile=node.js'].concat(flags), {
      'in.ts': `
        class Foo extends Array {
          #private: any
    ...
    // https://github.com/khulnasoft/ezburn/issues/3913
    test(['in.ts', '--outfile=node.js'].concat(flags), {
      'in.ts': `
  ...
  // https://github.com/khulnasoft/ezburn/issues/3177
  const input3177 = `
  ...
  const experimentalDecoratorsAndAccessors = `
    ...
    // Without ezburn's accessor syntax (should be the same)
    class Bar {
      #x = 1
  ...
  // https://github.com/khulnasoft/ezburn/issues/3768
  tests.push(
    test(['in.ts', '--outfile=node.js'].concat(flags), {
      'in.ts': `
        const bar = x => x
...
for (let flags of [[], ['--target=es2017'], ['--target=es6']]) {
  tests.push(
    ...
    test(['in.js', '--outfile=node.js', '--bundle'].concat(flags), {
      // Check edge case in https://github.com/khulnasoft/ezburn/issues/2158
      'in.js': `
      class Foo {
        constructor(x) {
          this.base = x
...
tests.push(
  ...
  // "sideEffects": false
  // https://github.com/khulnasoft/ezburn/issues/1081
  ...
  // https://github.com/khulnasoft/ezburn/issues/1123
  test(['a.js', 'b.js', '--outdir=out', '--splitting', '--format=esm', '--bundle'], {
    'a.js': `
  ...
  // https://github.com/khulnasoft/ezburn/issues/1125
  ...
  // https://github.com/khulnasoft/ezburn/issues/1201
  ...
  // https://github.com/khulnasoft/ezburn/issues/1252
...
// https://github.com/khulnasoft/ezburn/issues/822
tests.push(
  test(['in.js', '--bundle'], {
    'in.js': `
      import "/file.js"
    ...
    for (const format of formats) {
      ...
      try {
        ...
        if (options && options.cwd) {
          ...
          // handle symlinks correctly and some of these tests check ezburn's
          ...
          const command = ['cd', quote(cwd), '&&', quote(ezburnPath)].concat(modifiedArgs.map(quote)).join(' ')
          stderr = (await execAsync(command, { stdio: 'pipe' })).stderr
        } else {
          stderr = (await execFileAsync(ezburnPath, modifiedArgs, { cwd: thisTestDir, stdio: 'pipe' })).stderr
        }
    ...
    try {
      ...
      await callback(async () => {
        const { stdout } = await execFileAsync(
          ezburnPath, [inputFile, '--log-level=warning'].concat(args), { cwd: thisTestDir, stdio: 'pipe' })
        return stdout
      })
...
function testWatch(options, callback) {
  return async () => {
    ...
    try {
      ...
      // Start the child
      const child = childProcess.spawn(ezburnPath, args, {
        cwd: thisTestDir,
      ...
      try {
        ...
        const exitPromise = new Promise((_, reject) => {
          child.on('close', code => reject(new Error(`Child "ezburn" process exited with code ${code}`)))
        })
