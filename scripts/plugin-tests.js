...
let pluginTests = {
  async noPluginsWithBuildSync({ ezburn }) {
    try {
      ezburn.buildSync({
  ...
  async emptyArray({ ezburn, testDir }) {
  ...
  async emptyArrayWithBuildSync({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `export default 123`)
    ezburn.buildSync({
  ...
  async pluginMissingName({ ezburn }) {
    try {
      await ezburn.build({
        entryPoints: [],
        logLevel: 'silent',
  ...
  async pluginMissingSetup({ ezburn }) {
    try {
      await ezburn.build({
        entryPoints: [],
        logLevel: 'silent',
  ...
  async badPluginProperty({ ezburn }) {
    try {
      await ezburn.build({
        entryPoints: [],
        logLevel: 'silent',
  ...
  async badPluginOnResolveProperty({ ezburn }) {
    try {
      await ezburn.build({
        entryPoints: ['entry'],
        logLevel: 'silent',
  ...
  async badPluginOnLoadProperty({ ezburn }) {
    try {
      await ezburn.build({
        entryPoints: ['entry'],
        logLevel: 'silent',
  ...
  async modifyInitialOptions({ ezburn, testDir }) {
  ...
  async modifyInitialOptionsAsync({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.what')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `export default 123`)
    await ezburn.build({
  ...
  async basicLoader({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async basicResolver({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async fibonacciResolverMemoized({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `
  ...
  async fibonacciResolverNotMemoized({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `
      import x from 'fib(10)'
  ...
  async resolversCalledInSequence({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async loadersCalledInSequence({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const nested = path.join(testDir, 'nested.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `
  ...
  async httpRelative({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `
  ...
  async rewriteExternalWithNamespace({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `
  ...
  async rewriteExternalWithoutNamespace({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    await writeFileAsync(input, `
      import {exists} from 'extern'
  ...
  async rewriteExternalWithFileNamespace({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async resolveDirInFileModule({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
  ...
  async resolveWithSideEffectsFalse({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async noResolveDirInFileModule({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const example = path.join(testDir, 'example.custom')
    const resolveDir = path.join(testDir, 'target')
  ...
  async resolveDirInVirtualModule({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const resolveDir = path.join(testDir, 'target')
    const loadme = path.join(resolveDir, 'loadme.js')
  ...
  async noResolveDirInVirtualModule({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    const output = path.join(testDir, 'out.js')
    const resolveDir = path.join(testDir, 'target')
    const loadme = path.join(resolveDir, 'loadme.js')
    ...
    assert.strictEqual(error.errors[0].notes[0].text,
      ...
      `so ezburn did not search for "./loadme" on the file system.`)
  },

  async webAssembly({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async virtualEntryPoints({ ezburn, testDir }) {
    const result = await ezburn.build({
  ...
  async entryPointFileNamespace({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    let worked = false
  ...
  async stdinImporter({ ezburn, testDir }) {
    const output = path.join(testDir, 'out.js')
    await ezburn.build({
      stdin: {
  ...
  async stdinImporterResolveDir({ ezburn, testDir }) {
    const output = path.join(testDir, 'out.js')
    await ezburn.build({
      stdin: {
        contents: `import x from "plugin"; export default x`,
  ...
  async stdinAbsoluteImporterResolveDir({ ezburn, testDir }) {
    const output = path.join(testDir, 'out.js')
    await ezburn.build({
      stdin: {
        contents: `import x from "plugin"; export default x`,
  ...
  async stdinRelative({ ezburn, testDir }) {
    const output = path.join(testDir, 'out.js')
    await ezburn.build({
      stdin: {
  ...
  async stdinRelativeResolveDir({ ezburn, testDir }) {
  ...
  async externalRequire({ ezburn, testDir }) {
  ...
  async newlineInNamespace({ ezburn }) {
  ...
  async transformUndefinedDetailForError({ ezburn }) {
    try {
      await ezburn.transform('x y')
      throw new Error('Expected an error to be thrown')
    } catch (e) {
      assert.deepStrictEqual(e.warnings, [])
  ...
  async transformUndefinedDetailForWarning({ ezburn }) {
    const result = await ezburn.transform('typeof x == "null"')
  ...
  async buildUndefinedDetailForError({ ezburn }) {
    try {
      await ezburn.build({
        stdin: { contents: 'x y' },
        write: false,
  ...
  async buildUndefinedDetailForWarning({ ezburn }) {
    const result = await ezburn.build({
  ...
  async specificDetailForOnResolvePluginThrowError({ ezburn }) {
  ...
  async specificDetailForOnLoadPluginThrowError({ ezburn }) {
    const theError = new Error('theError');
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async specificDetailForOnResolvePluginReturnError({ ezburn }) {
    const theError = new Error('theError');
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async specificDetailForOnResolvePluginReturnWarning({ ezburn }) {
    const theError = new Error('theError');
    const result = await ezburn.build({
      entryPoints: ['entry'],
      write: false,
  ...
  async specificDetailForOnLoadPluginReturnError({ ezburn }) {
    const theError = new Error('theError');
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async specificDetailForOnLoadPluginReturnWarning({ ezburn }) {
    const theError = new Error('theError');
    const result = await ezburn.build({
      entryPoints: ['entry'],
      write: false,
  ...
  async pluginDataResolveToLoad({ ezburn }) {
    const theObject = {}
    const result = await ezburn.build({
      entryPoints: ['entry'],
      write: false,
  ...
  async pluginDataResolveToLoadNested({ ezburn }) {
    const theObject = {}
    const result = await ezburn.build({
      entryPoints: ['entry'],
      write: false,
  ...
  async pluginDataLoadToResolve({ ezburn }) {
    const theObject = {}
    const result = await ezburn.build({
      entryPoints: ['entry'],
      write: false,
  ...
  async resolveKindEntryPoint({ ezburn }) {
  ...
  async resolveKindImportStmt({ ezburn }) {
    let resolveKind = '<missing>'
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async resolveKindRequireCall({ ezburn }) {
    let resolveKind = '<missing>'
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async resolveKindDynamicImport({ ezburn }) {
    let resolveKind = '<missing>'
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async resolveKindRequireResolve({ ezburn }) {
    let resolveKind = '<missing>'
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async resolveKindAtImport({ ezburn }) {
    let resolveKind = '<missing>'
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async resolveKindComposesFrom({ ezburn }) {
    let resolveKind = '<missing>'
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async resolveKindURLToken({ ezburn }) {
    let resolveKind = '<missing>'
    try {
      await ezburn.build({
        entryPoints: ['entry'],
  ...
  async warnIfUnusedNoWarning({ ezburn }) {
  ...
  async onResolvePreserveOriginalEntryPointNameIssue945({ ezburn, testDir }) {
    const build = await ezburn.build({
      entryPoints: ['first'],
      write: false,
      logLevel: 'silent',
  ...
  async dynamicImportDuplicateChunkIssue1099({ ezburn, testDir }) {
    const outdir = path.join(testDir, 'out')
  ...
  async fileLoaderCustomNamespaceIssue1404({ ezburn, testDir }) {
  ...
  async ezburnProperty({ ezburn }) {
    ...
    await ezburn.build({
      ...
      plugins: [{
        name: 'plugin',
        setup(build) {
          ezburnFromBuild = build.ezburn
          build.onResolve({ filter: /.*/ }, () => ({ path: 'foo', namespace: 'bar' }))
          build.onLoad({ filter: /.*/ }, () => ({ contents: '' }))
        },
      }],
    })
    assert.deepStrictEqual({ ...ezburnFromBuild }, { ...ezburn })
  },

  async onResolveSuffixWithoutPath({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async onResolveInvalidPathSuffix({ ezburn }) {
    try {
      await ezburn.build({
        entryPoints: ['foo'],
        logLevel: 'silent',
...
error: Invalid path suffix "%what" returned from plugin (must start with "?" or "#")`)
  ...
  async onResolveWithInternalOnLoadAndQuerySuffix({ testDir, ezburn }) {
  ...
  async onLoadWithInternalOnResolveAndQuerySuffix({ testDir, ezburn }) {
    const entry = path.join(testDir, 'entry.js')
    await writeFileAsync(entry, `console.log('entry')`)
    const onResolveSet = new Set()
    const onLoadSet = new Set()
  ...
  async externalSideEffectsFalse({ ezburn }) {
    const build = await ezburn.build({
      entryPoints: ['entry'],
      bundle: true,
      write: false,
  ...
  async callResolveTooEarlyError({ ezburn }) {
    try {
      await ezburn.build({
        entryPoints: [],
        logLevel: 'silent',
  ...
  async callResolveTooLateError({ ezburn }) {
    let resolve
    await ezburn.build({
      entryPoints: [],
      plugins: [{
  ...
  async callResolveBadKindError({ ezburn }) {
    try {
      await ezburn.build({
        entryPoints: ['entry'],
        logLevel: 'silent',
  ...
  async callResolveUserOptionsExternal({ ezburn, testDir }) {
    const result = await ezburn.build({
  ...
  async callResolveBuiltInHandler({ ezburn, testDir }) {
  ...
  async callResolvePluginHandler({ ezburn, testDir }) {
    const srcDir = path.join(testDir, 'src')
    const input = path.join(srcDir, 'input.js')
    await mkdirAsync(srcDir, { recursive: true })
    await writeFileAsync(input, `console.log(123)`)
  ...
  async injectWithVirtualFile({ ezburn, testDir }) {
  ...
  async tsconfigRawAffectsVirtualFiles({ ezburn }) {
    const result = await ezburn.build({
      entryPoints: ['entry'],
      tsconfigRaw: {
        compilerOptions: {
  ...
  async importAttributesOnResolve({ ezburn }) {
    const result = await ezburn.build({
      entryPoints: ['entry'],
      bundle: true,
      format: 'esm',
...
`)
  ...
  async importAttributesOnLoad({ ezburn }) {
    const result = await ezburn.build({
      entryPoints: ['entry'],
      bundle: true,
      format: 'esm',
...
`)
  ...
  async importAttributesOnLoadGlob({ ezburn, testDir }) {
    const entry = path.join(testDir, 'entry.js')
  ...
  async importAttributesResolve({ ezburn }) {
    const onResolve = []
    const resolve = []
  ...
  async internalCrashIssue3634({ ezburn }) {
    await ezburn.build({
      entryPoints: [],
      bundle: true,
      plugins: [{
...
let syncTests = {
  async pluginWithWatchMode({ ezburn, testDir }) {
    const srcDir = path.join(testDir, 'src')
  ...
  async pluginWithWatchFiles({ ezburn, testDir }) {
    const srcDir = path.join(testDir, 'src')
  ...
  async pluginWithWatchDir({ ezburn, testDir }) {
    const srcDir = path.join(testDir, 'src')
    const otherDir = path.join(testDir, 'other')
    const outfile = path.join(testDir, 'out.js')
    const input = path.join(srcDir, 'in.js')
  ...
  async onStartCallback({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    await writeFileAsync(input, ``)
  ...
  async onStartCallbackWithDelay({ ezburn }) {
    await ezburn.build({
      entryPoints: ['foo'],
      write: false,
      logLevel: 'silent',
  ...
  async onEndCallback({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    await writeFileAsync(input, ``)
  ...
  async onEndCallbackMutateContents({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async onStartOnEndWatchMode({ ezburn, testDir }) {
    const srcDir = path.join(testDir, 'src')
    const outfile = path.join(testDir, 'out.js')
    const input = path.join(srcDir, 'in.js')
    const example = path.join(srcDir, 'example.js')
  ...
  async pluginServeWriteTrueOnEnd({ ezburn, testDir }) {
    const outfile = path.join(testDir, 'out.js')
    const input = path.join(testDir, 'in.js')
  ...
  async pluginServeWriteFalseOnEnd({ ezburn, testDir }) {
    const outfile = path.join(testDir, 'out.js')
    const input = path.join(testDir, 'in.js')
    await writeFileAsync(input, `console.log(1+2`)
  ...
  async pluginOnDisposeAfterSuccessfulBuild({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async pluginOnDisposeAfterFailedBuild({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
  ...
  async pluginOnDisposeWithUnusedContext({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    await writeFileAsync(input, `1+2`)

    let onDisposeCalled
    let onDisposePromise = new Promise(resolve => onDisposeCalled = resolve)
    let ctx = await ezburn.context({
      entryPoints: [input],
      write: false,
      plugins: [{
        name: 'x', setup(build) {
  ...
  async pluginOnDisposeWithRebuild({ ezburn, testDir }) {
    const input = path.join(testDir, 'in.js')
    await writeFileAsync(input, `1+2`)
