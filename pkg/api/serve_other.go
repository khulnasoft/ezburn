...
// This file implements the "Serve()" function in ezburn's public API. It
...
// ezburn will automatically generate a directory listing page with links for
...
func (h *apiHandler) ServeHTTP(res http.ResponseWriter, req *http.Request) {
	...
	// Special-case the ezburn event stream
	if req.Method == "GET" && req.URL.Path == "/ezburn" && req.Header.Get("Accept") == "text/event-stream" {
