...
// This file implements a polling file watcher for ezburn (i.e. it detects
...
//   * Polling is cross-platform and ezburn needs to work on 20+ platforms
...
func (w *watcher) start() {
	...
	go func() {
		...
		// People want to run regexes over ezburn's stderr stream to look for these
		// messages instead of using ezburn's API.
